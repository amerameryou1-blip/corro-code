...
server/runtime config schema는 [**`corrocode.dev/config.json`**](https://corrocode.dev/config.json)에 정의되어 있습니다.

TUI config는 [**`corrocode.dev/tui.json`**](https://corrocode.dev/tui.json)을 사용합니다.
