...
Practical reference for the current tool-migration state in `packages/corro`.
...
Tool tests should use the existing Effect helpers in `packages/corro/test/lib/effect.ts`:
