export const dict = {
  ...
  "desktop.updater.none.message": "آپ پہلے ہی Corro Code کا تازہ ترین ورژن استعمال کر رہے ہیں۔",
  ...
  "desktop.updater.downloaded.prompt":
    "Corro Code کا ورژن {{version}} ڈاؤن لوڈ ہو چکا ہے، کیا آپ اسے انسٹال کر کے دوبارہ لانچ کرنا چاہیں گے؟",
