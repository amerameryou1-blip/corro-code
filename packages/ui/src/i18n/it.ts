export const dict: Record<string, string> = {
  ...
  "ui.tool.loadedFile": "File {{path}} caricato",
  "ui.tool.loadedSkill": "Skill {{name}} caricata",
  "ui.tool.shell.writingCommand": "Scrittura del comando...",
  "ui.tool.agent.delegating": "Delega all'agente...",
  "ui.common.moreCount.one": "+{{count}} altro",
  "ui.common.moreCount.other": "+ altri {{count}}",
  "ui.common.moreCount.many": "+{{count}} in più",
  "ui.sessionTimeline.notice.model": "Modello",
  "ui.sessionTimeline.notice.movedTo": "Spostata in",
  "ui.sessionTimeline.notice.movedTooltip": "La directory di lavoro della sessione è cambiata",
  "ui.sessionTimeline.notice.failed": "{{actor}} non è riuscito",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} cancellato",
