...
- PR #15835: https://github.com/anomalyco/corro/pull/15835

## Do Not Translate (Locale Additions)

- `Corro Code` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `corro` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `Corro Code` in prose, `corro` only for exact technical identifiers
...
- Avoid changing `corro` to `Corro Code` inside commands, URLs, package names, or code literals
