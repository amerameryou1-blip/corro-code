---
title: TUI
description: Korištenje korisničkog interfejsa Corro Code terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Corro Code pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Corro Code pokreće TUI za trenutni direktorij.
...
Kada koristite Corro Code TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Corro Code. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Corro Code. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `corro.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo Corro Code čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `corro.default`.
