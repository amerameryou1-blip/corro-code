export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} Corro Code je bila prenesena, jo želite namestiti in znova zagnati?",
