export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van Corro Code is gedownload. Wil je deze installeren en Corro Code opnieuw starten?",
