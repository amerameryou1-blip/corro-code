...
function useShareUrl() {
  return isMock() ? "https://dev.corrocode.dev" : "https://corrocode.dev"
}
...
async function getAccessToken() {
  ...
  let response
  if (isMock()) {
    response = await fetch("https://api.corrocode.dev/exchange_github_app_token_with_pat", {
      method: "POST",
      headers: {
    ...
    response = await fetch("https://api.corrocode.dev/exchange_github_app_token", {
      method: "POST",
      headers: {
