export const dict = {
  ...
  "desktop.menu.documentation": "Corro Code Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "Corro Code մենյու",
  ...
  "desktop.recovery.loadFailed": "Corro Code չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "Corro Code պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "Corro Code-ը չի արձագանքում",
  ...
  "desktop.wsl.error.installOpencode": "Corro Code տեղադրումը ձախողվեց",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code տեղադրված չէ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Corro Code թարմացումն ավարտված է, բայց {{distro}}-ը դեռ հայտնում է {{installed}}; սպասվում է {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և Corro Code-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և Corro Code-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և Corro Code-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ Corro Code սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է Corro Code-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է Corro Code-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել Corro Code-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "Corro Code պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք Corro Code-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի Corro Code-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "Corro Code-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք Corro Code։",
  ...
  "help.tabs.introduction": "Corro Code Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Corro Code-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին Corro Code թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ Corro Code-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "Corro Code ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք Corro Code սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն Corro Code",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է Corro Code տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ Corro Code-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է Corro Code-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ Corro Code-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք Corro Code-ի վերջին տարբերակը։",
