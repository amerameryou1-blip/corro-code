export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu Corro Code",
  ...
  "desktop.recovery.loadFailed": "Không tải được Corro Code",
  "desktop.recovery.terminated": "Cửa sổ Corro Code đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "Corro Code không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được Corro Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật Corro Code nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do Corro Code cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong Corro Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong Corro Code.",
  ...
  "dialog.server.description": "Chuyển máy chủ Corro Code mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra Corro Code trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật Corro Code trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật Corro Code trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt Corro Code trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi Corro Code có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "Corro Code không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại Corro Code.",
  ...
  "help.tabs.introduction": "Corro Code Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của Corro Code ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm Corro Code",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: Corro Code chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ Corro Code bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho Corro Code",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của Corro Code trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem Corro Code tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của Corro Code.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi Corro Code khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của Corro Code.",
