export const dict = {
  ...
  "desktop.recovery.loadFailed": "Corro Code laadimine ebaõnnestus",
  "desktop.recovery.terminated": "Corro Code aken suleti ootamatult",
  "desktop.recovery.unresponsive": "Corro Code ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "Corro Code installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Corro Code värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid Corro Code'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises Corro Code.",
  ...
  "dialog.server.description": "Lülitage, millise Corro Code serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "Corro Code kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "Corro Code kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Corro Code värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "Corro Code värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda Corro Code jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige Corro Code asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui Corro Code saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "Corro Code ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti Corro Code.",
  ...
  "help.tabs.introduction": "Corro Code Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse Corro Code ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast Corro Code meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, Corro Code ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "Corro Code Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage Corro Code server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke Corro Code kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas Corro Code teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas Corro Code järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas Corro Code on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui Corro Code käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse Corro Code uusimat versiooni.",
