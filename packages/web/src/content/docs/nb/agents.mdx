...
Det er to typer agenter i Corro Code; primære agenter og underagenter.
...
Corro Code kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
Corro Code kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

Corro Code kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Konfigurer agenter i konfigurasjonsfilen `corro.json`:
...
Hvis ingen temperatur er spesifisert, bruker Corro Code modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale Corro Code-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i Corro Code-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [Corro Code Zen](/docs/zen), vil du bruke `corro/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `corro models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/anomalyco/corro).
:::
