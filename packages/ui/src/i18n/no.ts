...
export const dict: Record<Keys, string> = {
  ...
  "ui.tool.loadedFile": "Lastet inn {{path}}",
  "ui.tool.loadedSkill": "Lastet inn ferdigheten {{name}}",
  "ui.tool.shell.writingCommand": "Skriver kommando...",
  "ui.tool.agent.delegating": "Delegerer til agent...",
  "ui.common.moreCount.one": "+{{count}} til",
  "ui.common.moreCount.other": "+{{count}} til",
  "ui.sessionTimeline.notice.model": "Modell",
  "ui.sessionTimeline.notice.movedTo": "Flyttet til",
  "ui.sessionTimeline.notice.movedTooltip": "Sesjonens arbeidsmappe ble endret",
  "ui.sessionTimeline.notice.failed": "{{actor}} mislyktes",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} kansellert",
