...
// stats.corrocode.dev design tokens (light theme)
const c = {
  bg: "#ffffff",
  ink: "#161616",
  muted: "#5c5c5c",
...
// the correct opencode "DATA" wordmark (from stats.corrocode.dev header)
      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{ color: c.ink }}>corrocode.dev/data</div>
          </div>
        </div>
      </div>
    </AbsoluteFill>
