...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Corro Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Corro Code.",
  ...
  "dialog.server.description": "Switch which Corro Code server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Corro Code",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Corro Code in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Corro Code in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Corro Code in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Corro Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before Corro Code can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "Corro Code could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Corro Code.",
  ...
  "help.tabs.introduction": "Corro Code Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of Corro Code ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Corro Code team",
  ...
  "sidebar.gettingStarted.line1": "Corro Code includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Corro Code Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Corro Code server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Corro Code",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Corro Code looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Corro Code follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Corro Code is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Corro Code launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Corro Code.",
  ...
  "corro.welcome.title": "Welcome to Corro Code",
  "corro.welcome.tagline": "One client. Every great coding model.",
  "corro.welcome.body":
    "Sign in with Google to grab a free trial seat — one full week, 24/7. Your key is already inside, nothing to copy.",
  "corro.welcome.consent": "I agree my trial coding data is stored (raw + cleaned) to improve the free models.",
  "corro.welcome.signin": "Continue with Google",
  "corro.welcome.skip": "Skip for now",
  "corro.welcome.verifiedNote":
    "Seats are limited. If Google shows an 'app isn't verified' warning, tap Continue — normal for brand-new apps.",
  "corro.status.waiting": "Waiting for Google sign-in in your browser…",
  "corro.status.working": "Grabbing your free seat…",
  "corro.status.failed": "Sign-in failed: {{error}}",
  "corro.queue.title": "You're in the queue",
  "corro.queue.body": "You're #{{position}} in line. When a seat frees up you'll get an email — just keep the app open.",
  "corro.accepted.title": "Your seat is ready",
  "corro.accepted.body": "Your trial key is already inside — nothing to copy. Yours for one full week, 24/7.",
  "corro.accepted.go": "Start coding",
  "corro.expired.title": "Your week is up",
  "corro.expired.body": "Grab a fresh seat — or paste your own API key for unlimited use.",
  "corro.expired.rejoin": "Join the queue again",
  "corro.ownkey.toggle": "Use my own key instead",
  "corro.ownkey.label": "Your own API key — unlimited models, no seat needed.",
  "corro.ownkey.placeholder": "Paste key",
  "corro.ownkey.save": "Save key",
  "corro.ownkey.saved": "Own key saved — unlimited models, no seat needed.",
  "corro.ownkey.remove": "Remove key",
}
