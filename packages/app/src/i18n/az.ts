export const dict = {
  ...
  "desktop.recovery.loadFailed": "Corro Code yüklənə bilmədi",
  "desktop.recovery.terminated": "Corro Code pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Corro Code cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Corro Code quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Corro Code yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Corro Code tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Corro Code-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Corro Code-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Corro Code-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Corro Code serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Corro Code yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Corro Code yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Corro Code yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Corro Code yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Corro Code-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Corro Code-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Corro Code {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Corro Code hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Corro Code-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Corro Code quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Corro Code WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Corro Code bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Corro Code-u yenidən açın.",
  ...
  "help.tabs.introduction": "Corro Code Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Corro Code-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Corro Code komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Corro Code hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Corro Code serverini işlət.",
  ...
  "settings.general.row.language.description": "Corro Code üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Corro Code-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Corro Code-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Corro Code-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Corro Code açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Corro Code-un ən son versiyasından istifadə edirsiniz.",
