export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Corro Code",
  "desktop.recovery.terminated": "توقفت نافذة Corro Code بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Corro Code لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Corro Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Corro Code، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Corro Code",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Corro Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك Corro Code Trial الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Corro Code.",
  ...
  "dialog.server.description": "تبديل خادم Corro Code الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Corro Code في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Corro Code في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Corro Code في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Corro Code في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Corro Code من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Corro Code التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Corro Code.",
  ...
  "help.tabs.introduction": "أصبح Corro Code Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Corro Code ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Corro Code",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Corro Code لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Corro Code نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم Corro Code داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Corro Code",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Corro Code على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Corro Code يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Corro Code.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Corro Code",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Corro Code.",
