...
Use this folder for locale-specific translation guidance that supplements `.corro/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/corro/pull/12345

## Do Not Translate (Locale Additions)

- `Corro Code` (preserve casing)
