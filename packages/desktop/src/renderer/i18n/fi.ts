export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Corro Code uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Corro Code versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Corro Code uudelleen?",
