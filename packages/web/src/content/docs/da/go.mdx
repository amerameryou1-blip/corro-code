...
Corro Code Go er et lavprisabonnement til **$10/måned**, der giver dig pålidelig adgang til populære åbne kodningsmodeller.

Go fungerer som enhver anden udbyder i Corro Code. Du abonnerer på Corro Code Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med Corro Code.
:::
...
Corro Code Go giver dig adgang til disse modeller for **$10/måned**.

---

## Sådan fungerer det

Corro Code Go fungerer som enhver anden udbyder i Corro Code.

1. Du logger ind på **<a href={console}>Corro Code Zen</a>**, abonnerer på Go, og
   kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `Corro Code Go`, og indsætter
   din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over tilgængelige modeller gennem Go.

:::note
Kun ét medlem per arbejdsområde kan abonnere på Corro Code Go.
:::
...
Corro Code Go inkluderer følgende grænser:
...
Dit [model id](/docs/config/#models) i din Corro Code config
bruger formatet `corro-go/<model-id>`. For eksempel for Kimi K3, vil du
bruge `corro-go/kimi-k3` i din config.
...
Vi skabte Corro Code Go for at:
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med Corro Code.
