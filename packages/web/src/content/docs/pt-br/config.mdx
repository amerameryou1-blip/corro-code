...
O esquema de configuração do servidor/tempo de execução é definido em [**`corro.ai/config.json`**](https://corrocode.dev/config.json).

A configuração do TUI usa [**`corro.ai/tui.json`**](https://corrocode.dev/tui.json).
