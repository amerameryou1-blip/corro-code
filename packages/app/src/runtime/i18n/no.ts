...
export const dict = {
  ...
  "desktop.cli.installed.message":
    "CLI-en ble installert i {{path}}.\n\nStart terminalen på nytt for å bruke kommandoen 'opencode2'.",
  "desktop.cli.failed.title": "Installasjonen mislyktes",
  "desktop.cli.failed.message": "Kunne ikke installere CLI-en: {{error}}",
  "command.project.copyID": "Kopier prosjekt-ID",
  "command.session.copyID": "Kopier sesjons-ID",
  "server.row.incompatible":
    "Denne serveren kjører OpenCode {{version}}, som ikke er kompatibel med denne appen. Oppgrader den til OpenCode V2 for å fortsette.",
  "toast.session.copyID.failed.title": "Kunne ikke kopiere sesjons-ID-en",
  "toast.session.copyID.failed.description": "Det oppstod en feil under kopiering av sesjons-ID-en",
  "toast.project.copyID.failed.title": "Kunne ikke kopiere prosjekt-ID-en",
  "toast.project.copyID.failed.description": "Det oppstod en feil under kopiering av prosjekt-ID-en",
  "error.page.title.status": "Serverforespørselen mislyktes",
  "error.page.description.status": "Serveren returnerte et HTTP {{status}}-svar.",
  "error.page.action.reload": "Last inn på nytt",
  "session.error.incompatible": "Denne serverversjonen støttes ikke",
  "session.error.incompatible.description":
    "{{server}} kjører OpenCode {{version}}, som ikke er kompatibel med denne appen. Oppgrader serveren til OpenCode V2 for å fortsette.",
  "session.background.moveInline": "Trykk på {{keybind}} for å flytte pågående arbeid til bakgrunnen",
  "session.background.running": "Arbeid kjører i bakgrunnen",
  "session.background.runningCount.one": "{{count}} element kjører i bakgrunnen",
  "session.background.runningCount.other": "{{count}} elementer kjører i bakgrunnen",
  "settings.general.row.terminalPlacement.title": "Terminalplassering",
  "settings.general.row.terminalPlacement.description": "Velg hvor terminalen åpnes i sesjoner",
  "settings.general.row.terminalPlacement.side": "Siden",
  "settings.general.row.terminalPlacement.bottom": "Nederst",
  "settings.general.row.showProjectIcon.title": "Prosjektikon",
  "settings.general.row.showProjectIcon.description": "Vis prosjektikonet i sesjonsoverskriften",
