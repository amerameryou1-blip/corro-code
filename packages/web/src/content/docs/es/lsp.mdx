...
description: Corro Code se integra con sus servidores LSP.
---

Corro Code puede integrarse con servidores Language Server Protocol (LSP) para usar diagnósticos como feedback para el agente.

---

## Incorporados

Corro Code viene con varios servidores LSP integrados para idiomas populares:
...
Cuando LSP está habilitado y corro abre un archivo:
...
Puede habilitar y personalizar los servidores LSP a través de la sección `lsp` en su configuración corro.
