...
ไฟล์กำหนดค่ามีสคีมาที่กำหนดไว้ใน [**`corro.ai/config.json`**](https://corrocode.dev/config.json)

การกำหนดค่า TUI ใช้ [**`corro.ai/tui.json`**](https://corrocode.dev/tui.json)
