export const dict = {
  ...
  "ui.messagePart.context.match.one": "({{count}}件一致)",
  "ui.messagePart.context.match.other": "({{count}}件一致)",
  ...
  "ui.tool.loadedFile": "{{path}} を読み込みました",
  "ui.tool.loadedSkill": "{{name}}スキルを読み込みました",
  "ui.tool.shell.writingCommand": "コマンドを作成中...",
  "ui.tool.agent.delegating": "エージェントに委任中...",
  "ui.common.moreCount.one": "+{{count}} 件",
  "ui.common.moreCount.other": "+{{count}} 件",
  "ui.sessionTimeline.notice.model": "モデル",
  "ui.sessionTimeline.notice.movedTo": "移動先",
  "ui.sessionTimeline.notice.movedTooltip": "セッションの作業ディレクトリが変更されました",
  "ui.sessionTimeline.notice.failed": "{{actor}} が失敗しました",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} がキャンセルされました",
  "ui.sessionTimeline.notice.finished": "{{actor}} が完了しました",
  "ui.sessionTimeline.notice.instructionsUpdated": "指示が更新されました",
  "ui.sessionTimeline.notice.restart": "再起動後に続行",
}
