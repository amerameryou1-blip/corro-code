...
const docs = `### Overview
Line comment **display** and **editor** cards aligned with Corro Code line-comment specs (raised \`#FAFAFA\` surface, footer line context, \`ButtonV2\` neutral + contrast actions).
