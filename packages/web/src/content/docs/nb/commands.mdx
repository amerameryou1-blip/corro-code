...
Opprett `.corro/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom Corro Code-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i Corro Code [config](/docs/config):
...
- Globalt: `~/.config/corro/commands/`
- Per prosjekt: `.corro/commands/`
...
Corro Code inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
