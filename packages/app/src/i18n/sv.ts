export const dict = {
  ...
  "desktop.recovery.loadFailed": "Corro Code kunde inte läsas in",
  "desktop.recovery.terminated": "Corro Code-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Corro Code svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Corro Code misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Corro Code-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Corro Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Corro Code.",
  ...
  "dialog.server.description": "Växla vilken Corro Code-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Corro Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Corro Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Corro Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Corro Code i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Corro Code kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Corro Code kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Corro Code igen.",
  ...
  "help.tabs.introduction": "Corro Code Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Corro Code ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Corro Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Corro Code stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör Corro Code-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Corro Code",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Corro Code ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Corro Code följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Corro Codes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Corro Code startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Corro Code.",
