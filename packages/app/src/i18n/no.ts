...
export const dict = {
  ...
  "desktop.menu.documentation": "Corro Code-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Corro Code-meny",
  ...
  "desktop.recovery.loadFailed": "Corro Code kunne ikke lastes inn",
  "desktop.recovery.terminated": "Corro Code-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "Corro Code svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Corro Code mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Corro Code er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Corro Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Corro Code.",
  ...
  "dialog.server.description": "Bytt hvilken Corro Code-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Corro Code ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Corro Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Corro Code ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Corro Code-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Corro Code",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Corro Code ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Corro Code skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Corro Code.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Corro Code starter",
  ...
  "settings.updates.toast.latest.title": "Corro Code er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Corro Code.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Corro Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Corro Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Corro Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer Corro Code i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Corro Code kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Corro Code kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Corro Code på nytt.",
  ...
  "help.tabs.introduction": "Corro Code Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
