export const dict = {
  ...
  "desktop.cli.installed.message":
    "CLI is geïnstalleerd in {{path}}.\n\nStart de terminal opnieuw om de opdracht 'opencode2' te gebruiken.",
  "desktop.cli.failed.title": "Installatie mislukt",
  "desktop.cli.failed.message": "Kan CLI niet installeren: {{error}}",
  "command.project.copyID": "Project-ID kopiëren",
  "command.session.copyID": "Sessie-ID kopiëren",
  "server.row.incompatible":
    "Op deze server wordt OpenCode {{version}} uitgevoerd, dat niet compatibel is met deze app. Werk de server bij naar OpenCode V2 om door te gaan.",
  "toast.session.copyID.failed.title": "Kan sessie-ID niet kopiëren",
  "toast.session.copyID.failed.description": "Er is een fout opgetreden bij het kopiëren van de sessie-ID",
  "toast.project.copyID.failed.title": "Kan project-ID niet kopiëren",
  "toast.project.copyID.failed.description": "Er is een fout opgetreden bij het kopiëren van de project-ID",
  "error.page.title.status": "Serververzoek mislukt",
  "error.page.description.status": "De server heeft een HTTP {{status}}-antwoord geretourneerd.",
  "error.page.action.reload": "Opnieuw laden",
  "session.error.incompatible": "Deze serverversie wordt niet ondersteund",
  "session.error.incompatible.description":
    "Op {{server}} wordt OpenCode {{version}} uitgevoerd, dat niet compatibel is met deze app. Werk de server bij naar OpenCode V2 om door te gaan.",
  "session.background.moveInline": "Druk op {{keybind}} om actief werk naar de achtergrond te verplaatsen",
  "session.background.running": "Werk wordt op de achtergrond uitgevoerd",
  "session.background.runningCount.one": "{{count}} item wordt op de achtergrond uitgevoerd",
  "session.background.runningCount.other": "{{count}} items worden op de achtergrond uitgevoerd",
  "settings.general.row.terminalPlacement.title": "Terminalpositie",
  "settings.general.row.terminalPlacement.description": "Kies waar de terminal in sessies wordt geopend",
  "settings.general.row.terminalPlacement.side": "Zijkant",
  "settings.general.row.terminalPlacement.bottom": "Onderkant",
  "settings.general.row.showProjectIcon.title": "Projectpictogram",
  "settings.general.row.showProjectIcon.description": "Toon het projectpictogram in de sessiekop",
}
