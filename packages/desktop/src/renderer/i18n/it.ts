export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di Corro Code è stata scaricata. Vuoi installarla e riavviare l'app?",
