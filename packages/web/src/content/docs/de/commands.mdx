...
Erstellen Sie `.corro/commands/test.md`:

```md title=".corro/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die Corro Code-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem Corro Code [config](/docs/config):

```json title="corro.jsonc" {4-12}
{
...
- Global: `~/.config/corro/commands/`
- Pro Projekt: `.corro/commands/`

```markdown title="~/.config/corro/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".corro/commands/component.md"
---
...
```md title=".corro/commands/create-file.md"
---
...
```md title=".corro/commands/analyze-coverage.md"
---
...
```md title=".corro/commands/review-changes.md"
---
...
```md title=".corro/commands/review-component.md"
---
...
Corro Code enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
