...
Agentferdigheter lar Corro Code oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
Corro Code søker etter disse stedene:

- Prosjektkonfigurasjon: `.corro/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/corro/skills/<name>/SKILL.md`
...
For prosjektlokale stier går Corro Code opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.corro/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/corro/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.corro/skills/git-release/SKILL.md` slik:
...
Corro Code viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `corro.json`:
...
**For innebygde agenter** (i `corro.json`):
