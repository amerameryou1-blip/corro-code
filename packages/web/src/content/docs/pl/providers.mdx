...
1. Uruchom polecenie `/connect` w TUI, wybierz `Corro Code Zen` i przejdź do [corro.ai/auth](https://corrocode.dev/zen).
...
1. Uruchom polecenie `/connect` w TUI, wybierz `Corro Code Go` i przejdź do [corro.ai/auth](https://corrocode.dev/zen).
