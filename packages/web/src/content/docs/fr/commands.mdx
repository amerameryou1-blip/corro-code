...
Vous pouvez ajouter des commandes personnalisées via la configuration Corro Code ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre Corro Code [config](/docs/config) :
...
corro comprend plusieurs commandes intégrées comme `/init`, `/undo`, `/redo`, `/share`, `/help` ; [en savoir plus](/docs/tui#commands).
