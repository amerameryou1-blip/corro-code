export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i Corro Code është shkarkuar, dëshironi ta instaloni dhe rinisni?",
