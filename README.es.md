...
npm i -g corro-ai@latest        # o bun/pnpm/yarn
...
Corro Code también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/corro/releases) o desde [corro.ai/download](https://corrocode.dev/download).
