export const dict = {
  ...
  "command.session.copyID": "Avrita setu-ID",
  "server.row.incompatible":
    "Hesin ambætarin koyrir OpenCode {{version}}, sum ikki samsvarar við hetta forritið. Dagfør hann til OpenCode V2 fyri at halda fram.",
  "toast.session.copyID.failed.title": "Tað eydnaðist ikki at avrita setu-ID",
  "toast.session.copyID.failed.description": "Ein villa kom fyri, meðan setu-ID varð avritað",
  "toast.project.copyID.failed.title": "Tað eydnaðist ikki at avrita verkætlanar-ID",
  "toast.project.copyID.failed.description": "Ein villa kom fyri, meðan verkætlanar-ID varð avritað",
  "error.page.title.status": "Fyrispurningurin til ambætaran miseydnaðist",
  "error.page.description.status": "Ambætarin svaraði við HTTP {{status}}.",
  "error.page.action.reload": "Les inn aftur",
  "session.error.incompatible": "Henda ambætaraútgávan verður ikki stuðlað",
  "session.error.incompatible.description":
    "{{server}} koyrir OpenCode {{version}}, sum ikki samsvarar við hetta forritið. Dagfør ambætaran til OpenCode V2 fyri at halda fram.",
  "session.background.moveInline": "Trýst á {{keybind}} fyri at flyta arbeiðið, ið koyrir, í bakgrundina",
  "session.background.running": "Arbeiði koyrir í bakgrundini",
  "session.background.runningCount.one": "{{count}} arbeiði koyrir í bakgrundini",
  "session.background.runningCount.other": "{{count}} arbeiði koyra í bakgrundini",
  "settings.general.row.terminalPlacement.title": "Staðseting av terminali",
  "settings.general.row.terminalPlacement.description": "Vel, hvar terminalurin skal lata upp í setum",
  "settings.general.row.terminalPlacement.side": "Á síðuni",
  "settings.general.row.terminalPlacement.bottom": "Niðast",
  "settings.general.row.showProjectIcon.title": "Verkætlanarímynd",
  "settings.general.row.showProjectIcon.description": "Vís verkætlanarímyndina í setuhøvdinum",
}
