...
# 패키지 매니저
npm i -g corro-ai@latest        # bun/pnpm/yarn 도 가능
...
Corro Code 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/anomalyco/corro/releases) 에서 직접 다운로드하거나 [corro.ai/download](https://corrocode.dev/download) 를 이용하세요.
