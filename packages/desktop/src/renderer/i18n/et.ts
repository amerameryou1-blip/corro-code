export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse Corro Code uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "Corro Code'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
