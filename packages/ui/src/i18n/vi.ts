export const dict: Record<string, string> = {
  ...
  "ui.messagePart.context.match.one": "({{count}} kết quả khớp)",
  "ui.messagePart.context.match.other": "({{count}} kết quả khớp)",
  ...
  "ui.tool.loadedFile": "Đã tải {{path}}",
  "ui.tool.loadedSkill": "Đã tải kỹ năng {{name}}",
  "ui.tool.shell.writingCommand": "Đang viết lệnh...",
  "ui.tool.agent.delegating": "Đang phân công cho tác nhân...",
  "ui.common.moreCount.one": "+{{count}} mục khác",
  "ui.common.moreCount.other": "+{{count}} mục khác",
  "ui.sessionTimeline.notice.model": "Mô hình",
  "ui.sessionTimeline.notice.movedTo": "Đã chuyển đến",
  "ui.sessionTimeline.notice.movedTooltip": "Thư mục làm việc của phiên đã thay đổi",
  "ui.sessionTimeline.notice.failed": "{{actor}} thất bại",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} đã bị hủy",
  "ui.sessionTimeline.notice.finished": "{{actor}} đã hoàn tất",
  "ui.sessionTimeline.notice.instructionsUpdated": "Đã cập nhật hướng dẫn",
  "ui.sessionTimeline.notice.restart": "Tiếp tục sau khi khởi động lại",
}
