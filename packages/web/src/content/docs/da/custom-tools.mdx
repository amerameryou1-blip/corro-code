...
description: Opret værktøjer, som LLM kan kalde corro ind.
---
...
- Lokalt ved at placere dem i biblioteket `.corro/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/corro/tools/`.
