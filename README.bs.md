...
# Package manageri
npm i -g @corro-code@latest        # ili bun/pnpm/yarn
...
Corro Code je dostupan i kao desktop aplikacija. Preuzmi je direktno sa [stranice izdanja](https://github.com/anomalyco/corro/releases) ili sa [corrocode.dev/download](https://corrocode.dev/download).
