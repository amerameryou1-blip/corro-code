export const dict = {
  ...
  "command.session.copyID": "Sao chép ID phiên",
  "server.row.incompatible":
    "Máy chủ này đang chạy OpenCode {{version}}, không tương thích với ứng dụng này. Hãy nâng cấp lên OpenCode V2 để tiếp tục.",
  "toast.session.copyID.failed.title": "Không thể sao chép ID phiên",
  "toast.session.copyID.failed.description": "Đã xảy ra lỗi khi sao chép ID phiên",
  "toast.project.copyID.failed.title": "Không thể sao chép ID dự án",
  "toast.project.copyID.failed.description": "Đã xảy ra lỗi khi sao chép ID dự án",
  "error.page.title.status": "Yêu cầu đến máy chủ thất bại",
  "error.page.description.status": "Máy chủ trả về phản hồi HTTP {{status}}.",
  "error.page.action.reload": "Tải lại",
  "session.error.incompatible": "Phiên bản máy chủ này không được hỗ trợ",
  "session.error.incompatible.description":
    "{{server}} đang chạy OpenCode {{version}}, không tương thích với ứng dụng này. Hãy nâng cấp máy chủ lên OpenCode V2 để tiếp tục.",
  "session.background.moveInline": "Nhấn {{keybind}} để chuyển tác vụ đang chạy sang nền",
  "session.background.running": "Đang chạy tác vụ trong nền",
  "session.background.runningCount.one": "{{count}} mục đang chạy trong nền",
  "session.background.runningCount.other": "{{count}} mục đang chạy trong nền",
  "settings.general.row.terminalPlacement.title": "Vị trí terminal",
  "settings.general.row.terminalPlacement.description": "Chọn vị trí mở terminal trong các phiên",
  "settings.general.row.terminalPlacement.side": "Bên cạnh",
  "settings.general.row.terminalPlacement.bottom": "Phía dưới",
  "settings.general.row.showProjectIcon.title": "Biểu tượng dự án",
  "settings.general.row.showProjectIcon.description": "Hiển thị biểu tượng dự án trong tiêu đề phiên",
}
