export const dict = {
  ...
  "command.session.copyID": "ສຳເນົາ ID ເຊດຊັນ",
  "server.row.incompatible":
    "ເຊີບເວີນີ້ກຳລັງໃຊ້ OpenCode {{version}} ທີ່ບໍ່ເຂົ້າກັນກັບແອັບນີ້. ອັບເກຣດເປັນ OpenCode V2 ເພື່ອສືບຕໍ່.",
  "toast.session.copyID.failed.title": "ສຳເນົາ ID ເຊດຊັນບໍ່ສຳເລັດ",
  "toast.session.copyID.failed.description": "ເກີດຂໍ້ຜິດພາດຂະນະສຳເນົາ ID ເຊດຊັນ",
  "toast.project.copyID.failed.title": "ສຳເນົາ ID ໂຄງການບໍ່ສຳເລັດ",
  "toast.project.copyID.failed.description": "ເກີດຂໍ້ຜິດພາດຂະນະສຳເນົາ ID ໂຄງການ",
  "error.page.title.status": "ຄຳຂໍໄປຫາເຊີບເວີລົ້ມເຫລວ",
  "error.page.description.status": "ເຊີບເວີສົ່ງຄຳຕອບ HTTP {{status}} ກັບຄືນມາ.",
  "error.page.action.reload": "ໂຫຼດຄືນໃໝ່",
  "session.error.incompatible": "ບໍ່ຮອງຮັບເຊີບເວີລຸ້ນນີ້",
  "session.error.incompatible.description":
    "{{server}} ກຳລັງໃຊ້ OpenCode {{version}} ທີ່ບໍ່ເຂົ້າກັນກັບແອັບນີ້. ອັບເກຣດເຊີບເວີເປັນ OpenCode V2 ເພື່ອສືບຕໍ່.",
  "session.background.moveInline": "ກົດ {{keybind}} ເພື່ອຍ້າຍວຽກທີ່ກຳລັງເຮັດໄປເບື້ອງຫຼັງ",
  "session.background.running": "ກຳລັງເຮັດວຽກຢູ່ເບື້ອງຫຼັງ",
  "session.background.runningCount.one": "ມີ {{count}} ລາຍການກຳລັງເຮັດວຽກຢູ່ເບື້ອງຫຼັງ",
  "session.background.runningCount.other": "ມີ {{count}} ລາຍການກຳລັງເຮັດວຽກຢູ່ເບື້ອງຫຼັງ",
  "settings.general.row.terminalPlacement.title": "ຕຳແໜ່ງສະຖານີ",
  "settings.general.row.terminalPlacement.description": "ເລືອກບ່ອນທີ່ສະຖານີຈະເປີດໃນເຊດຊັນ",
  "settings.general.row.terminalPlacement.side": "ດ້ານຂ້າງ",
  "settings.general.row.terminalPlacement.bottom": "ດ້ານລຸ່ມ",
  "settings.general.row.showProjectIcon.title": "ໄອຄອນໂຄງການ",
  "settings.general.row.showProjectIcon.description": "ສະແດງໄອຄອນໂຄງການໃນສ່ວນຫົວຂອງເຊດຊັນ",
}
