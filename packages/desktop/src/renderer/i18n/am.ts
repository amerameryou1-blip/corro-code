export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የCorro Code ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከCorro Code ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
