...
Файл конфигурации имеет схему, определенную в [**`corro.ai/config.json`**](https://corrocode.dev/config.json).

Конфигурация TUI использует [**`corro.ai/tui.json`**](https://corrocode.dev/tui.json).
