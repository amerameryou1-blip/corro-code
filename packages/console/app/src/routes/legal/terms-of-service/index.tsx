...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Corro Code | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Corro Code terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Corro Code. Please read on to learn the rules and restrictions that govern your use of
                Corro Code&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Corro Code," "we" and "us"). Your use of the Services in any
                ...
                <a href={language.route("/legal/privacy-policy")}>https://corrocode.dev/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-opencode">What is Corro Code?</h2>
              <p>
                Corro Code is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Corro Code Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Corro Code enables you to
              ...
              <p>
                ...
                our site located at corrocode.dev, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Corro Code takes the privacy of its users very seriously. For the current Corro Code Privacy Policy, please
                click here{" "}
                <a href="https://corrocode.dev/legal/privacy-policy">https://corrocode.dev/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using Corro Code?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Corro Code;
                </li>
                <li>
              ...
              <p>
                If you use Corro Code with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Corro Code. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Corro Code has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-opencode-ever-change-the-services">Will Corro Code ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href={language.route("/zen")}>https://corrocode.dev/zen</a> for a description of the current Paid
              ...
              <p>
                ...
                <a href="https://corrocode.dev/auth">https://corrocode.dev/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href={language.route("/legal/privacy-policy")}>https://corrocode.dev/legal/privacy-policy</a>, as well
                as the licenses above, to understand how we treat information you provide to us after you have stopped
                using our Services.
              </p>

              <p>
                Corro Code is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Corro Code has the sole right to decide whether you are
              ...
              <p>
                Corro Code and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Corro Code and all such
                parties together, the "Corro Code Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Corro Code Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Corro Code Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Corro Code Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Corro Code's prior written
              ...
              <p>
                ...
                disputes and claims with Corro Code and limits the manner in which you can seek relief from Corro Code. Both
                you and Corro Code acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Corro Code's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Corro Code will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Corro Code will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Corro Code may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and Corro Code are instead choosing to have claims and disputes resolved by
                ...
                you and Corro Code over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                Corro Code is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Corro Code to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Corro Code agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Corro Code may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Corro Code agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Corro Code, and
                ...
                are not an employee, agent, partner, or joint venture of Corro Code, and you do not have any authority of
                any kind to bind Corro Code in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Corro Code
