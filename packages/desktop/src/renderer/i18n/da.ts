export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Corro Code er blevet downloadet. Vil du installere den og genstarte?",
