...
Corro Code est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/anomalyco/corro/releases) ou [corro.ai/download](https://corrocode.dev/download).
