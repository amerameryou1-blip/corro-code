...
Możesz zdefiniować polecenia w `corro.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji corro:
...
- Globalnie: `~/.config/corro/commands/`
- Na projekt: `.corro/commands/`
...
corro zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
