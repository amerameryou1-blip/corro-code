...
Puede agregar comandos personalizados a través de la configuración Corro Code o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Corro Code [config](/docs/config):
...
corro incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
