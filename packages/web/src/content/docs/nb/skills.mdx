...
Agentferdigheter lar Corro Code oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
corro søker etter disse stedene:
...
For prosjektlokale stier går corro opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
corro viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `corro.json`:
