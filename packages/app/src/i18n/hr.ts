...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "Corro Code se nije uspio učitati",
  "Prozor aplikacije Corro Code neočekivano je zatvoren",
  "Corro Code ne reagira",
  ...
  "Instalacija aplikacije Corro Code nije uspjela",
  ...
  "Corro Code nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije Corro Code je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u Corro Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u Corro Code.",
  ...
  "dialog.server.description": "Promijenite na koji se Corro Code poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera Corro Code u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Corro Code u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte Corro Code u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte Corro Code u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte Corro Code",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što Corro Code može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "Corro Code nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite Corro Code.",
  ...
  "help.tabs.introduction": "Radna površina Corro Code sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Corro Code ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku Corro Code timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, Corro Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "Corro Code Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite Corro Code poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za Corro Code",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako Corro Code izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li Corro Code slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je Corro Code tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se Corro Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju Corro Code.",
