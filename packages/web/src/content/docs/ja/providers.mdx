...
1. TUI で `/connect` コマンドを実行し、`Corro Code Zen` を選択して、[corro.ai/zen](https://corrocode.dev/zen) にアクセスします。
...
1. TUI で `/connect` コマンドを実行し、`Corro Code Go` を選択して、[corro.ai/zen](https://corrocode.dev/zen) にアクセスします。
