export const dict = {
  ...
  "ui.tool.loadedFile": "Arquivo {{path}} carregado",
  "ui.tool.loadedSkill": "Habilidade {{name}} carregada",
  "ui.tool.shell.writingCommand": "Escrevendo comando...",
  "ui.tool.agent.delegating": "Delegando para o agente...",
  "ui.common.moreCount.one": "+ mais {{count}}",
  "ui.common.moreCount.other": "+ mais {{count}}",
  "ui.common.moreCount.many": "+ mais {{count}}",
  "ui.sessionTimeline.notice.model": "Modelo",
  "ui.sessionTimeline.notice.movedTo": "Movida para",
  "ui.sessionTimeline.notice.movedTooltip": "O diretório de trabalho da sessão foi alterado",
  "ui.sessionTimeline.notice.failed": "{{actor}} falhou",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} cancelado",
  "ui.sessionTimeline.notice.finished": "{{actor}} finalizado",
  "ui.sessionTimeline.notice.instructionsUpdated": "Instruções atualizadas",
  "ui.sessionTimeline.notice.restart": "Continuando após a reinicialização",
}
