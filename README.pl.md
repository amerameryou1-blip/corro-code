...
# Menedżery pakietów
npm i -g @corro-code@latest        # albo bun/pnpm/yarn
...
Corro Code jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/anomalyco/corro/releases) lub z [corrocode.dev/download](https://corrocode.dev/download).
