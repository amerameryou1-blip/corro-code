export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi Corro Code",
  ...
  "desktop.recovery.loadFailed": "Corro Code gagal dimuat",
  "desktop.recovery.terminated": "Jendela Corro Code berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "Corro Code tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi Corro Code gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan Corro Code selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di Corro Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di Corro Code.",
  ...
  "dialog.server.description": "Ganti server Corro Code mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa Corro Code di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui Corro Code di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui Corro Code di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code siap.",
  "wsl.onboarding.installOpencodeIn": "Instal Corro Code di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Corro Code dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Corro Code tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali Corro Code.",
  ...
  "help.tabs.introduction": "Corro Code Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru Corro Code ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim Corro Code",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: Corro Code belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server Corro Code di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk Corro Code",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan Corro Code di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah Corro Code mengikuti tema sistem, terang, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema Corro Code.",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat Corro Code diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru Corro Code.",
