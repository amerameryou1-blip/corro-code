export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | Corro Code Data",
  "app.description":
    "Explora el uso de Corro Code en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de Corro Code Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a Corro Code en GitHub",
  "header.github": "GitHub",
  "header.tryCorro Code": "Probar Corro Code",
  ...
  "footer.homeAria": "Inicio de Corro Code",
  ...
  "modal.title": "Boletín de Corro Code",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en Corro Code.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de Corro Code por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | Corro Code Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en Corro Code, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de Corro Code.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en Corro Code",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de Corro Code",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de Corro Code durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | Corro Code Data",
  "model.description":
    "Consulta datos de uso de {{model}} en Corro Code, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de Corro Code aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de Corro Code de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de Corro Code de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de Corro Code en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de Corro Code, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de Corro Code.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de Corro Code durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de Corro Code durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de Corro Code.",
  ...
  "model.noGeoDescription": "Ninguna fila geográfica de Corro Code coincidió con este modelo.",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de Corro Code.",
