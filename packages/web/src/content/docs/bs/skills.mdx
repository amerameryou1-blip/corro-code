...
Agent skills omogucavaju Corro Code da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
Corro Code pretrazuje ove lokacije:

- Konfiguracija projekta: `.corro/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/corro/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, Corro Code ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.corro/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/corro/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.corro/skills/git-release/SKILL.md` ovako:
...
Corro Code navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `corro.json`:
...
**Za ugradene agente** (u `corro.json`):
