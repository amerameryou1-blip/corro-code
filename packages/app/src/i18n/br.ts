export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Corro Code",
  ...
  "desktop.menu.ariaLabel": "Menu do Corro Code",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Corro Code",
  "desktop.recovery.terminated": "A janela do Corro Code foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Corro Code não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Corro Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O Corro Code não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Corro Code foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Corro Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Corro Code.",
  ...
  "dialog.server.description": "Trocar para qual servidor Corro Code este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Corro Code em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Corro Code em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Corro Code em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Corro Code",
  "wsl.onboarding.opencodeReadyIn": "O Corro Code está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Corro Code está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Corro Code em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Corro Code possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Corro Code não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Corro Code novamente.",
  ...
  "help.tabs.introduction": "Agora, o Corro Code Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Corro Code ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Corro Code",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Corro Code ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Corro Code dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Corro Code",
  ...
  "settings.general.row.appearance.description": "Personalize como o Corro Code aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Corro Code segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Corro Code é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Corro Code iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Corro Code.",
