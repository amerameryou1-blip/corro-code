export const dict = {
  ...
  "desktop.updater.none.message": "Bạn đang sử dụng phiên bản mới nhất của Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Phiên bản {{version}} của Corro Code đã được tải xuống, bạn có muốn cài đặt và khởi chạy lại không?",
