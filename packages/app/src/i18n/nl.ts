export const dict = {
  ...
  "desktop.menu.documentation": "Corro Code-documentatie",
  ...
  "desktop.recovery.loadFailed": "Corro Code kan niet worden geladen",
  "desktop.recovery.terminated": "Het Corro Code-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Corro Code reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Corro Code is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Corro Code-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Corro Code te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Corro Code te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Corro Code te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Corro Code-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Corro Code controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Corro Code controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Corro Code bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Corro Code bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Corro Code bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Corro Code bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Corro Code is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Corro Code in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Corro Code een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Corro Code kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Corro Code opnieuw.",
  ...
  "help.tabs.introduction": "Corro Code Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Corro Code ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Corro Code-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Corro Code ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de Corro Code-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Corro Code",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Corro Code eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Corro Code het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Corro Code aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Corro Code wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Corro Code is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Corro Code.",
