...
npm i -g @corro-code@latest        # o bun/pnpm/yarn
scoop install corro             # Windows
choco install corro             # Windows
brew install anomalyco/tap/corro # macOS y Linux (recomendado, siempre al día)
brew install corro              # macOS y Linux (fórmula oficial de brew, se actualiza menos)
sudo pacman -S corro            # Arch Linux (Stable)
paru -S corro-bin               # Arch Linux (Latest from AUR)
mise use -g corro               # cualquier sistema
nix run nixpkgs#corro           # o github:anomalyco/corro para la rama dev más reciente
```
...
Corro Code también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/anomalyco/corro/releases) o desde [corrocode.dev/download](https://corrocode.dev/download).
...
4. `$HOME/.corro/bin` - Alternativa por defecto
...
Corro Code incluye dos agentes integrados que puedes alternar con la tecla `Tab`.
...
Más información sobre [agentes](https://corrocode.dev/docs/agents).

### Documentación

Para más información sobre cómo configurar Corro Code, [**ve a nuestra documentación**](https://corrocode.dev/docs).

### Contribuir

Si te interesa contribuir a Corro Code, lee nuestras [docs de contribución](./CONTRIBUTING.md) antes de enviar un pull request.

### Proyectos basados en Corro Code

Si estás trabajando en un proyecto basado en Corro Code y usas "corro" como parte del nombre, por ejemplo, "corro-dashboard" u "corro-mobile", agrega una nota en tu README para aclarar que no está hecho por el equipo de Corro Code y que no está afiliado con nosotros de ninguna manera.

---

**Únete a nuestra comunidad** [Discord](https://discord.gg/corro) | [X.com](https://x.com/corro)
