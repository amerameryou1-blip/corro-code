---
title: خوادم LSP
description: يتكامل Corro Code مع خوادم LSP لديك.
---

يمكن أن يتكامل Corro Code مع خوادم Language Server Protocol (LSP) لاستخدام التشخيصات كملاحظات للوكيل.

---

## المدمجة

يأتي Corro Code مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عند تفعيل LSP وفتح corro لملف، فإنه:
...
يمكنك تفعيل خوادم LSP وتخصيصها عبر قسم `lsp` في إعدادات corro.
