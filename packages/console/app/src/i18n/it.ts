...
export const dict = {
  ...
  "app.meta.description": "Corro Code - L'agente di programmazione open source.",

  "home.title": "Corro Code | L'agente di coding IA open source",
  ...
  "temp.screenshot.caption": "Corro Code TUI con il tema tokyonight",
  "temp.screenshot.alt": "Corro Code TUI con tema tokyonight",
  ...
  "home.what.title": "Che cos'è Corro Code?",
  "home.what.body": "Corro Code è un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "home.growth.body":
    "Con oltre <strong>{{stars}}</strong> stelle su GitHub, <strong>{{contributors}}</strong> contributori e oltre <strong>{{commits}}</strong> commit, Corro Code è usato e apprezzato da oltre <strong>{{monthlyUsers}}</strong> sviluppatori ogni mese.",
  ...
  "home.privacy.body":
    "Corro Code non archivia il tuo codice né i dati di contesto, così può operare in ambienti sensibili alla privacy.",
  "home.privacy.learnMore": "Scopri di più su",
  "home.privacy.link": "privacy",

  "home.faq.q1": "Che cos'è Corro Code?",
  "home.faq.a1":
    "Corro Code è un agente open source che ti aiuta a scrivere ed eseguire codice con qualsiasi modello di IA. È disponibile come interfaccia terminale, app desktop o estensione IDE.",
  "home.faq.q2": "Come uso Corro Code?",
  "home.faq.a2.before": "Il modo più semplice per iniziare è leggere l'",
  "home.faq.a2.link": "introduzione",
  "home.faq.q3": "Mi servono abbonamenti IA extra per usare Corro Code?",
  "home.faq.a3.p1":
    "Non necessariamente: Corro Code include un set di modelli gratuiti che puoi usare senza creare un account.",
  "home.faq.a3.p2.beforeZen": "Inoltre, puoi usare modelli popolari per il coding creando un account",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Anche se incoraggiamo gli utenti a usare Zen, Corro Code funziona anche con i provider più diffusi come OpenAI, Anthropic, xAI, ecc.",
  "home.faq.a3.p4.beforeLocal": "Puoi anche collegare i tuoi",
  "home.faq.a3.p4.localLink": "modelli locali",
  "home.faq.q4": "Posso usare i miei abbonamenti IA esistenti con Corro Code?",
  "home.faq.a4.p1":
    "Sì, Corro Code supporta gli abbonamenti dei principali provider. Puoi usare Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Posso usare Corro Code solo nel terminale?",
  "home.faq.a5.beforeDesktop": "Non più! Corro Code ora è disponibile come app per",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto costa Corro Code?",
  "home.faq.a6":
    "Corro Code è gratuito al 100%. Include anche un set di modelli gratuiti. Potrebbero esserci costi aggiuntivi se colleghi altri provider.",
  ...
  "home.faq.q8": "Corro Code è open source?",
  "home.faq.a8.p1": "Sì, Corro Code è completamente open source. Il codice sorgente è pubblico su",
  ...
  "home.zenCta.body":
    "Zen ti dà accesso a una selezione di modelli di IA che Corro Code ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",
  "home.zenCta.link": "Scopri Zen",

  "zen.title": "Corro Code Zen | Una selezione curata di modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.title": "Accedi a modelli affidabili e ottimizzati per agenti di coding",
  "zen.hero.body":
    "Zen ti dà accesso a una selezione di modelli di IA che Corro Code ha testato e benchmarkato specificamente per agenti di coding. Niente più preoccupazioni per prestazioni e qualità incoerenti tra provider: usa modelli validati che funzionano.",

  "zen.faq.q1": "Cos'è Corro Code Zen?",
  "zen.faq.a1":
    "Zen è un set curato di modelli di IA testati e benchmarkati per agenti di coding, creato dal team dietro Corro Code.",
  ...
  "zen.faq.a3":
    "Zen non è a scopo di lucro. Zen ribalta i costi dei provider di modelli direttamente su di te. Più Zen viene usato, più Corro Code può negoziare tariffe migliori e passarle a te.",
  ...
  "zen.faq.a4.p3":
    "Per coprire i costi, Corro Code aggiunge solo una piccola commissione di elaborazione del pagamento di $1.23 per ogni ricarica di saldo da $20.",
  ...
  "zen.faq.a8":
    "Anche se Zen funziona alla grande con Corro Code, puoi usare Zen con qualsiasi agente. Segui le istruzioni di configurazione nel tuo agente di coding preferito.",
  ...
  "zen.problem.subtitle": "Stiamo risolvendo questo problema per tutti, non solo per gli utenti Corro Code.",
  ...
  "zen.how.body": "Anche se ti consigliamo di utilizzare Zen con Corro Code, puoi utilizzare Zen con qualsiasi agente.",
  ...
  "go.title": "Corro Code Go | Modelli di coding a basso costo per tutti",
  ...
  "go.problem.body":
    "Ci concentriamo nel portare l'esperienza Corro Code a quante più persone possibile. Corro Code Go è un abbonamento a basso costo da $10/mese. Offre limiti generosi e accesso affidabile ai modelli open source più capaci.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go costa $10/mese. Puoi usarlo con Corro Code o qualsiasi agente.",
  ...
  "go.faq.q1": "Che cos'è Corro Code Go?",
  "go.faq.a1":
  ...
  "go.faq.a5.model": "Modello",
  "go.faq.a5.training": "Addestramento del modello",
  "go.faq.a5.retention": "Conservazione dei dati",
  "go.faq.a5.retention30": "30 giorni",
  "go.faq.a5.retention0": "0 giorni",
  ...
  "zen.api.error.trialEnded":
    "La promozione gratuita di {{model}} è terminata. Puoi continuare a usare il modello abbonandoti a Corro Code Go - {{link}}",

  "black.meta.title": "Corro Code Black | Accedi ai migliori modelli di coding al mondo",
  "black.meta.description":
    "Ottieni l'accesso a Claude, GPT, Gemini e altri con i piani di abbonamento Corro Code Black.",
  "black.hero.title": "Accedi ai migliori modelli di coding al mondo",
  "black.hero.subtitle": "Inclusi Claude, GPT, Gemini e altri",
  "black.title": "Corro Code Black | Prezzi",
  ...
  "black.workspace.title": "Corro Code Black | Seleziona Workspace",
  "black.workspace.selectPlan": "Seleziona un workspace per questo piano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Abbonati a Corro Code Black",
  ...
  "black.subscribe.success.title": "Sei nella lista d'attesa di Corro Code Black",
  ...
  "workspace.black.subscription.message": "Sei abbonato a Corro Code Black per ${{plan}} al mese.",
  ...
  "workspace.black.waitlist.joined": "Sei nella waitlist per il piano Corro Code Black da ${{plan}} al mese.",
  "workspace.black.waitlist.ready": "Siamo pronti per iscriverti al piano Corro Code Black da ${{plan}} al mese.",
  ...
  "workspace.lite.subscription.message": "Sei abbonato a Corro Code Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Seleziona "Corro Code Go" come provider nella tua configurazione opencode per utilizzare i modelli Go.',
  ...
  "workspace.lite.black.message":
    "Attualmente sei abbonato a Corro Code Black o sei in lista d'attesa. Annulla l'iscrizione prima se desideri passare a Go.",
  "workspace.lite.other.message":
    "Un altro membro in questo workspace è già abbonato a Corro Code Go. Solo un membro per workspace può abbonarsi.",
  "workspace.lite.promo.description":
    "Corro Code Go costa {{price}} e offre un accesso affidabile a popolari modelli di coding aperti con generosi limiti di utilizzo.",
  ...
  "download.meta.description": "Scarica Corro Code per macOS, Windows e Linux",
  "download.hero.title": "Scarica Corro Code Desktop",
  ...
  "download.section.integrations": "Corro Code Integrations",
  ...
  "download.faq.a3.beforeLocal":
    "Non necessariamente, ma probabilmente. Avrai bisogno di un abbonamento IA se vuoi collegare Corro Code a un provider a pagamento, sebbene tu possa lavorare con",
  ...
  "download.faq.a3.afterZen": ", Corro Code funziona con tutti i provider popolari come OpenAI, Anthropic, xAI ecc.",

  "download.faq.a5.p1": "Corro Code è gratuito al 100%.",
  "download.faq.a5.p2.beforeZen":
    "Eventuali costi aggiuntivi proverranno dal tuo abbonamento a un provider di modelli. Mentre Corro Code funziona con qualsiasi provider di modelli, raccomandiamo di usare",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in Corro Code.",
  "download.faq.a6.p2.beforeShare": "Scopri di più sulle",
  "download.faq.a6.shareLink": "pagine condivise",

  "enterprise.title": "Corro Code | Soluzioni Enterprise per la tua organizzazione",
  "enterprise.meta.description": "Contatta Corro Code per soluzioni enterprise",
  "enterprise.hero.title": "Il tuo codice è tuo",
  "enterprise.hero.body1":
    "Corro Code opera in modo sicuro all'interno della tua organizzazione senza dati o contesto archiviati e senza restrizioni di licenza o rivendicazioni di proprietà. Inizia una prova con il tuo team, poi distribuisci attraverso la tua organizzazione integrandolo con il tuo SSO e gateway IA interno.",
  ...
  "enterprise.faq.q1": "Cos'è Corro Code Enterprise?",
  "enterprise.faq.a1":
    "Corro Code Enterprise è per le organizzazioni che vogliono garantire che il loro codice e dati non lascino mai la loro infrastruttura. Può farlo usando una configurazione centralizzata che si integra con il tuo SSO e gateway IA interno.",
  "enterprise.faq.q2": "Come inizio con Corro Code Enterprise?",
  "enterprise.faq.a2":
    "Inizia semplicemente con una prova interna con il tuo team. Corro Code per impostazione predefinita non archivia il tuo codice o dati di contesto, rendendo facile iniziare. Poi contattaci per discutere prezzi e opzioni di implementazione.",
  ...
  "enterprise.faq.q4": "I miei dati sono sicuri con Corro Code Enterprise?",
  "enterprise.faq.a4":
    "Sì. Corro Code non archivia il tuo codice o dati di contesto. Tutto il trattamento avviene localmente o attraverso chiamate API dirette al tuo provider IA. Con configurazione centrale e integrazione SSO, i tuoi dati rimangono sicuri all'interno dell'infrastruttura della tua organizzazione.",

  "brand.title": "Corro Code | Brand",
  "brand.meta.description": "Linee guida del brand Corro Code",
  "brand.heading": "Linee guida del brand",
  "brand.subtitle": "Risorse e asset per aiutarti a lavorare con il brand Corro Code.",
  "brand.downloadAll": "Scarica tutti gli asset",

  "changelog.title": "Corro Code | Changelog",
  "changelog.meta.description": "Note di rilascio e changelog Corro Code",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Nuovi aggiornamenti e miglioramenti a Corro Code",
