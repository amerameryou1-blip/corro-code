export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'Corro Code",
  ...
  "desktop.menu.ariaLabel": "Menu Corro Code",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'Corro Code",
  "desktop.recovery.terminated": "La fenêtre Corro Code s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "Corro Code ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'Corro Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'Corro Code est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Corro Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Corro Code.",
  ...
  "dialog.server.description": "Changez le serveur Corro Code auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'Corro Code dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'Corro Code dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour Corro Code dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez Corro Code dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'Corro Code puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "Corro Code n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez Corro Code.",
  ...
  "help.tabs.introduction": "Corro Code Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'Corro Code ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Corro Code",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Corro Code ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Corro Code inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Corro Code dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Corro Code",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Corro Code sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si Corro Code suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Corro Code.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Corro Code",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Corro Code.",
