---
title: Paylasim
description: corro konusmalarini genel baglantilarla paylasin.
---

corro'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda corro:
...
corro, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak corro manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `corro.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda corro kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
