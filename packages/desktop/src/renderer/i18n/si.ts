export const dict: Record<string, string> = {
  ...
  "desktop.updater.none.message": "ඔබ දැනටමත් Corro Code හි නවතම අනුවාදය භාවිතා කරයි",
  ...
  "desktop.updater.downloaded.prompt":
    "Corro Code හි {{version}} අනුවාදය බාගෙන ඇත, ඔබ එය ස්ථාපනය කර නැවත දියත් කිරීමට කැමතිද?",
