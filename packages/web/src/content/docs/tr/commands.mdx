...
`.corro/commands/test.md` oluştur:
...
corro işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

corro [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/corro/commands/`
- Proje başına: `.corro/commands/`
...
corro, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
