export const dict = {
  ...
  "command.session.copyID": "Sessiya ID-sini kopyala",
  "server.row.incompatible":
    "Bu server bu tətbiqlə uyğun olmayan OpenCode {{version}} versiyasını işlədir. Davam etmək üçün onu OpenCode V2-yə yeniləyin.",
  "toast.session.copyID.failed.title": "Sessiya ID-sini kopyalamaq mümkün olmadı",
  "toast.session.copyID.failed.description": "Sessiya ID-si kopyalanarkən xəta baş verdi",
  "toast.project.copyID.failed.title": "Layihə ID-sini kopyalamaq mümkün olmadı",
  "toast.project.copyID.failed.description": "Layihə ID-si kopyalanarkən xəta baş verdi",
  "error.page.title.status": "Server sorğusu uğursuz oldu",
  "error.page.description.status": "Server HTTP {{status}} cavabı qaytardı.",
  "error.page.action.reload": "Yenidən yüklə",
  "session.error.incompatible": "Bu server versiyası dəstəklənmir",
  "session.error.incompatible.description":
    "{{server}} bu tətbiqlə uyğun olmayan OpenCode {{version}} versiyasını işlədir. Davam etmək üçün serveri OpenCode V2-yə yeniləyin.",
  "session.background.moveInline": "İşləyən işi arxa plana keçirmək üçün {{keybind}} basın",
  "session.background.running": "İş arxa planda davam edir",
  "session.background.runningCount.one": "{{count}} element arxa planda işləyir",
  "session.background.runningCount.other": "{{count}} element arxa planda işləyir",
  "settings.general.row.terminalPlacement.title": "Terminalın yerləşməsi",
  "settings.general.row.terminalPlacement.description": "Sessiyalarda terminalın harada açılacağını seçin",
  "settings.general.row.terminalPlacement.side": "Yan tərəf",
  "settings.general.row.terminalPlacement.bottom": "Aşağı",
  "settings.general.row.showProjectIcon.title": "Layihə nişanı",
  "settings.general.row.showProjectIcon.description": "Sessiya başlığında layihə nişanını göstərin",
}
