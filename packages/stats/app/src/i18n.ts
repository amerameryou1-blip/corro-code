...
const en = {
  "app.title": "AI Model Usage Rankings | Corro Code Data",
  "app.description":
    "Explore Corro Code usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "Corro Code Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star Corro Code on GitHub",
  "header.github": "GitHub",
  "header.tryOpenCode": "Try Corro Code",
  ...
  "footer.homeAria": "Corro Code home",
  ...
  "home.topModelsDescription": "Usage of models across Corro Code.",
  ...
  "home.uniqueUsersDescription": "Daily unique Corro Code users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | Corro Code Data",
  "lab.description":
    "Compare {{lab}} models used in Corro Code, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent Corro Code usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in Corro Code",
  ...
  "lab.shareOfUsage": "{{share}} of recent Corro Code usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | Corro Code Data",
  "model.description":
    "View {{model}} Corro Code usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. Corro Code usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's Corro Code usage",
  "model.ranked": "Ranked #{{rank}} across last week's Corro Code usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No Corro Code usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no Corro Code usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No Corro Code geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent Corro Code token volume.",
