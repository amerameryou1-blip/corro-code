...
1. Kjør kommandoen `/connect` i TUI, velg `Corro Code Zen` og gå til [corro.ai/auth](https://corrocode.dev/zen).
...
1. Kjør kommandoen `/connect` i TUI, velg `Corro Code Go`, og gå til [corro.ai/auth](https://corrocode.dev/zen).
