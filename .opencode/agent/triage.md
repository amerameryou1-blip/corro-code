...
Desktop application and browser-based app issues, including `corro web`, desktop-specific UI behavior, packaging, and web view problems.

### Core

Core corro server and harness issues, including sqlite, snapshots, memory, API behavior, agent context construction, tool execution, provider integrations, model behavior, documentation, and larger architectural features.

### Inference

Corro Code Zen, Corro Code Go, and billing issues.
