export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent d'Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} d'Corro Code. Voleu instal·lar-la i reiniciar l'aplicació?",
