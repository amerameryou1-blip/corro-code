...
export const dict = {
  ...
  "settings.general.row.showProjectIcon.title": "Projekto piktograma",
  "settings.general.row.showProjectIcon.description": "Rodyti projekto piktogramą seanso antraštėje",
}
