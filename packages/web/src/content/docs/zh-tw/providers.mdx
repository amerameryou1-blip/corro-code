...
1. 在 TUI 中執行 `/connect` 指令，選擇 `Corro Code Zen`，然後前往 [corro.ai/auth](https://corrocode.dev/zen)。
...
1. 在 TUI 中執行 `/connect` 指令，選擇 `Corro Code Go`，然後前往 [corro.ai/auth](https://corrocode.dev/zen)。
