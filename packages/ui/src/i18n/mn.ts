export const dict = {
  ...
  "ui.tool.loadedFile": "{{path}}-г ачааллаа",
  "ui.tool.loadedSkill": "{{name}} ур чадварыг ачааллаа",
  "ui.tool.shell.writingCommand": "Команд бичиж байна...",
  "ui.tool.agent.delegating": "Агент руу шилжүүлж байна...",
  "ui.common.moreCount.one": "+өөр {{count}}",
  "ui.common.moreCount.other": "+өөр {{count}}",
  "ui.sessionTimeline.notice.model": "Загвар",
  "ui.sessionTimeline.notice.movedTo": "Шилжүүлсэн газар",
  "ui.sessionTimeline.notice.movedTooltip": "Сессийн ажлын хавтас өөрчлөгдлөө",
  "ui.sessionTimeline.notice.failed": "{{actor}} амжилтгүй боллоо",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} цуцлагдлаа",
  "ui.sessionTimeline.notice.finished": "{{actor}} дууслаа",
  "ui.sessionTimeline.notice.instructionsUpdated": "Заавар шинэчлэгдлээ",
  "ui.sessionTimeline.notice.restart": "Дахин эхлүүлсний дараа үргэлжлүүлж байна",
}
