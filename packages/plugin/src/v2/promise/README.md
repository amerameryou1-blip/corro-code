...
The Promise plugin API is the async/await equivalent of `@corro-ai/plugin/v2/effect`. It grants plugins the same two in-process capabilities:
...
```ts
import { define } from "@corro-ai/plugin/v2/promise"
