---
title: Dijeljenje
description: Dijelite Corro Code razgovore javnim linkovima.
---

Corro Code opcija dijeljenja vam omogucava da kreirate javne linkove za razgovore. Tako lakse saradujete s timom ili trazite pomoc od drugih.
...
Kada podijelite razgovor, Corro Code:
...
Corro Code podrzava tri nacina dijeljenja koji odreduju kako se razgovori dijele:

---

### Ručno (zadano)

Po defaultu, Corro Code koristi rucni nacin dijeljenja. Sesije se ne dijele automatski, ali ih mozete rucno podijeliti komandom `/share`:
...
Da ovo vazi za cijeli tim u odredenom projektu, dodajte postavku u projektni `corro.json` i commitujte u Git.
...
[Saznajte vise](/docs/enterprise) o koristenju corro u organizaciji.
