...
# Менеджеры пакетов
npm i -g corro-ai@latest        # или bun/pnpm/yarn
...
Corro Code также доступен как десктопное приложение. Скачайте его со [страницы релизов](https://github.com/anomalyco/corro/releases) или с [corro.ai/download](https://corrocode.dev/download).
