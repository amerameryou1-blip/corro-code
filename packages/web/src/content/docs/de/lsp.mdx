---
title: LSP Server
description: Corro Code lässt sich in Ihren LSP-Server integrieren.
---

Corro Code kann sich in Language Server Protocol (LSP)-Server integrieren, um Diagnosen als Feedback für den Agenten zu verwenden.

---

## Integriert

Corro Code verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
Wenn LSP aktiviert ist und Corro Code eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer Corro Code-Konfiguration aktivieren und anpassen.
