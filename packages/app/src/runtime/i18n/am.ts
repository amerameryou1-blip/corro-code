export const dict = {
  ...
  "command.session.copyID": "የክፍለ ጊዜ IDን ቅዳ",
  "server.row.incompatible":
    "ይህ አገልጋይ OpenCode {{version}}ን እያስኬደ ነው፣ ይህም ከዚህ መተግበሪያ ጋር ተኳሃኝ አይደለም። ለመቀጠል ወደ OpenCode V2 ያሻሽሉት።",
  "toast.session.copyID.failed.title": "የክፍለ ጊዜ IDን መቅዳት አልተሳካም",
  "toast.session.copyID.failed.description": "የክፍለ ጊዜ IDን ሲቀዳ ስህተት ተፈጥሯል",
  "toast.project.copyID.failed.title": "የፕሮጀክት IDን መቅዳት አልተሳካም",
  "toast.project.copyID.failed.description": "የፕሮጀክት IDን ሲቀዳ ስህተት ተፈጥሯል",
  "error.page.title.status": "የአገልጋይ ጥያቄ አልተሳካም",
  "error.page.description.status": "አገልጋዩ የHTTP {{status}} ምላሽ መልሷል።",
  "error.page.action.reload": "ዳግም ጫን",
  "session.error.incompatible": "ይህ የአገልጋይ ስሪት አይደገፍም",
  "session.error.incompatible.description":
    "{{server}} OpenCode {{version}}ን እያስኬደ ነው፣ ይህም ከዚህ መተግበሪያ ጋር ተኳሃኝ አይደለም። ለመቀጠል አገልጋዩን ወደ OpenCode V2 ያሻሽሉት።",
  "session.background.moveInline": "እየሄደ ያለውን ሥራ ወደ ዳራ ለማንቀሳቀስ {{keybind}}ን ይጫኑ",
  "session.background.running": "ሥራ በዳራ እየሄደ ነው",
  "session.background.runningCount.one": "{{count}} ንጥል በዳራ እየሄደ ነው",
  "session.background.runningCount.other": "{{count}} ንጥሎች በዳራ እየሄዱ ነው",
  "settings.general.row.terminalPlacement.title": "የተርሚናል አቀማመጥ",
  "settings.general.row.terminalPlacement.description": "ተርሚናሉ በክፍለ ጊዜዎች ውስጥ የት እንደሚከፈት ይምረጡ",
  "settings.general.row.terminalPlacement.side": "ጎን",
  "settings.general.row.terminalPlacement.bottom": "ታች",
  "settings.general.row.showProjectIcon.title": "የፕሮጀክት አዶ",
  "settings.general.row.showProjectIcon.description": "የፕሮጀክት አዶውን በክፍለ ጊዜው ራስጌ ውስጥ አሳይ",
}
