...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez corro et dirigez-vous vers [corro.ai/auth](https://corrocode.dev/auth).
...
1. Exécutez la commande `/connect` dans le TUI, sélectionnez `Corro Code Go` et rendez-vous sur [corro.ai/auth](https://corrocode.dev/zen).
