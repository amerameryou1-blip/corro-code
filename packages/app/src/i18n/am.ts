export const dict = {
  ...
  "desktop.recovery.loadFailed": "Corro Code መጫን አልቻለም",
  "desktop.recovery.terminated": "Corro Code መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "Corro Code ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "Corro Codeመጫኑ አልተሳካም",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "Corro Code ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በCorro Code",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በCorro Code ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "Corro Code Trial ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በCorro Code ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በCorro Code ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው Corro Code አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Corro Codeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ Corro Code በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን Corro Code በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "Corro Code ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን Corro Code በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Codeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) Corro Code WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "Corro Code በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ Corro Code።",
  ...
  "help.tabs.introduction": "Corro Code ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የCorro Code ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለCorro Code ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ Corro Code እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "Corro Code ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "Corro Code ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የCorro Code አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለCorro Code",
  ...
  "settings.general.row.appearance.description": "Corro Codeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "Corro Code ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "Corro Code ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "Corro Code ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የCorro Code እትም እያሄዱ ነው።",
