...
1. شغّل الأمر `/connect` في TUI، واختر corro، ثم انتقل إلى [corro.ai/auth](https://corrocode.dev/auth).
...
1. شغّل الأمر `/connect` في TUI، واختر `Corro Code Go`، ثم انتقل إلى [corro.ai/auth](https://corrocode.dev/zen).
