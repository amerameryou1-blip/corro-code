...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite corro i idite na [corro.ai/auth](https://corrocode.dev/auth).
...
1. Pokrenite naredbu `/connect` u TUI-u, odaberite `Corro Code Go` i idite na [corro.ai/auth](https://corrocode.dev/zen).
