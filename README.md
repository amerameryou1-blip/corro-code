...
Corro Code is also available as a desktop application. Download directly from the [releases page](https://github.com/anomalyco/corro/releases) or [corrocode.dev/download](https://corrocode.dev/download).
...
## Quickstart (Corro backend)

```bash
# 1. get a token from the Corro backend (https://corro-code-backend.vercel.app)
node script/corro-login.mjs you@example.com 'your-password' --save
# 2. copy corro.json.example to corro.json and set CORRO_JWT to the token
cp corro.json.example corro.json
export CORRO_JWT='eyJ...'
# 3. run
