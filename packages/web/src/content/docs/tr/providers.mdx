...
1. TUI'de `/connect` komutunu çalıştırın, corro'u seçin ve [corro.ai/auth](https://corrocode.dev/auth)'ye gidin.
...
1. TUI'de `/connect` komutunu çalıştırın, `Corro Code Go`'yu seçin ve [corro.ai/auth](https://corrocode.dev/zen) adresine gidin.
