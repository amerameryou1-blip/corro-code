...
export const dict = {
  ...
  "ui.messagePart.context.match.one": "（{{count}} 個相符項目）",
  "ui.messagePart.context.match.other": "（{{count}} 個相符項目）",
  "ui.tool.execute": "執行",
  "ui.tool.loadedFile": "已載入 {{path}}",
  "ui.tool.loadedSkill": "已載入技能 {{name}}",
  "ui.tool.shell.writingCommand": "正在撰寫命令...",
  "ui.tool.agent.delegating": "正在委派代理程式...",
  "ui.common.moreCount.one": "+{{count}} 個",
  "ui.common.moreCount.other": "+{{count}} 個",
  "ui.sessionTimeline.notice.model": "模型",
  "ui.sessionTimeline.notice.movedTo": "已移至",
  "ui.sessionTimeline.notice.movedTooltip": "工作階段工作目錄已變更",
  "ui.sessionTimeline.notice.failed": "{{actor}} 失敗",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} 已取消",
  "ui.sessionTimeline.notice.finished": "{{actor}} 已完成",
  "ui.sessionTimeline.notice.instructionsUpdated": "指令已更新",
  "ui.sessionTimeline.notice.restart": "重新啟動後繼續",
