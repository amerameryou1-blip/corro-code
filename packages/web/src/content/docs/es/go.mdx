...
Corro Code Go es una suscripción de bajo costo de **$10/mes** que te brinda acceso confiable a modelos abiertos de programación populares.

Go funciona como cualquier otro proveedor en Corro Code. Te suscribes a Corro Code Go y
...
Corro Code Go te da acceso a estos modelos por **$10/mes**.

---

## Cómo funciona

Corro Code Go funciona como cualquier otro proveedor en Corro Code.

1. Inicias sesión en **<a href={console}>Corro Code Zen</a>**, te suscribes a Go y
   copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas `Corro Code Go` y pegas
   tu API key.
3. Ejecutas `/models` en la TUI para ver la lista de modelos disponibles a través de Go.

:::note
Solo un miembro por espacio de trabajo puede suscribirse a Corro Code Go.
:::
...
Corro Code Go incluye los siguientes límites:
...
El [ID del modelo](/docs/config/#models) en tu configuración de Corro Code
usa el formato `corro-go/<model-id>`. Por ejemplo, para Kimi K3, usarías
`corro-go/kimi-k3` en tu configuración.
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con Corro Code.
