...
> current private `@corro-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@corro-ai/ai`
...
import { LLM } from "@corro-ai/ai"
import { OpenAI } from "@corro-ai/ai/providers/openai"
...
```ts
import { Message } from "@corro-ai/ai"
...
import { LLM, Tool } from "@corro-ai/ai"
...
```ts
import { LLM } from "@corro-ai/ai/promise"
import { OpenAI } from "@corro-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@corro-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@corro-ai/ai/provider"
...
@corro-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@corro-ai/ai/providers/openai
@corro-ai/ai/providers/anthropic
@corro-ai/ai/providers/google
...
```
