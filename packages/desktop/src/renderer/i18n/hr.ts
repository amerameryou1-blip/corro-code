export const dict = {
  ...
  "desktop.updater.none.message": "Već koristite najnoviju verziju Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Preuzeta je verzija {{version}} aplikacije Corro Code. Želite li je instalirati i ponovno pokrenuti aplikaciju?",
