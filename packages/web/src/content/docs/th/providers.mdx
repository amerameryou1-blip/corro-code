...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก corro และไปที่ [corro.ai/auth](https://corrocode.dev/auth)
...
1. เรียกใช้คำสั่ง `/connect` ใน TUI เลือก `Corro Code Go` และไปที่ [corro.ai/auth](https://corrocode.dev/zen)
