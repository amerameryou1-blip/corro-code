export const dict: Record<string, string> = {
  ...
  "ui.tool.loadedFile": "ჩაიტვირთა {{path}}",
  "ui.tool.loadedSkill": "ჩაიტვირთა {{name}} უნარი",
  "ui.tool.shell.writingCommand": "ბრძანება იწერება...",
  "ui.tool.agent.delegating": "აგენტისთვის გადაცემა...",
  "ui.common.moreCount.one": "+კიდევ {{count}}",
  "ui.common.moreCount.other": "+კიდევ {{count}}",
  "ui.sessionTimeline.notice.model": "მოდელი",
  "ui.sessionTimeline.notice.movedTo": "გადატანილია",
  "ui.sessionTimeline.notice.movedTooltip": "სესიის სამუშაო საქაღალდე შეიცვალა",
  "ui.sessionTimeline.notice.failed": "{{actor}} ვერ შესრულდა",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} გაუქმდა",
