...
description: Lag verktøy som LLM kan kalle inn Corro Code.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med Corro Code sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.corro/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/corro/tools/`.
