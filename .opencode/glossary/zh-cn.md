...
- PR #13942: https://github.com/anomalyco/corro/pull/13942

## Do Not Translate (Locale Additions)

- `Corro Code` (preserve casing in prose; keep `corro` only when it is part of commands, package names, paths, or code)
- `Corro Code Zen`
- `Corro Code CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `corro` in prose when referring to the product name; use `Corro Code`
