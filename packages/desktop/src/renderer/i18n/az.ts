export const dict = {
  ...
  "desktop.menu.installCli": "CLI-ni quraşdır...",
  ...
  "desktop.updater.none.message": "Artıq Corro Code-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "Corro Code-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
