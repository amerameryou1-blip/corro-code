...
1. Execute o comando `/connect` no TUI, selecione `Corro Code Zen` e acesse [corro.ai/zen](https://corrocode.dev/zen).
...
1. Execute o comando `/connect` no TUI, selecione `Corro Code Go` e acesse [corro.ai/zen](https://corrocode.dev/zen).
