...
Schema-first LLM core for corro. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@corro-code/llm"
import { OpenAI } from "@corro-code/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@corro-code/llm/providers"
