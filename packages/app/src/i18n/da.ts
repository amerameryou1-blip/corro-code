export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i Corro Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i Corro Code.",
  ...
  "dialog.server.description": "Skift hvilken Corro Code-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker Corro Code i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer Corro Code i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater Corro Code i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før Corro Code kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "Corro Code kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter Corro Code igen.",
  ...
  "toast.update.description": "En ny version af Corro Code ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Corro Code-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Corro Code understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Corro Code-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Corro Code",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan Corro Code ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om Corro Code skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas Corro Codes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Corro Code starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Corro Code.",
  ...
  "desktop.recovery.loadFailed": "Corro Code kunne ikke indlæses",
  "desktop.recovery.terminated": "Corro Code-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af Corro Code mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af Corro Code er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "Corro Code Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
