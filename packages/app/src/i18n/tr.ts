...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Corro Code yüklenemedi",
  "desktop.recovery.terminated": "Corro Code penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "Corro Code yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "Corro Code kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "Corro Code güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Corro Code tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Corro Code'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak Corro Code'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Corro Code'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Corro Code sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Corro Code kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde Corro Code kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "Corro Code güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde Corro Code güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki Corro Code'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "Corro Code'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde Corro Code hazır.",
  "wsl.onboarding.opencodeReady": "Corro Code hazır.",
  "wsl.onboarding.installOpencodeIn": "Corro Code'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "Corro Code'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Corro Code'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "Corro Code bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından Corro Code'u tekrar açın.",
  ...
  "help.tabs.introduction": "Corro Code Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Corro Code'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Corro Code ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: Corro Code henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Corro Code Masaüstü",
  ...
  "settings.desktop.wsl.description": "Corro Code sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Corro Code'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "Corro Code'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "Corro Code'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Corro Code'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Corro Code başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Corro Code'un en son sürümünü kullanıyorsunuz.",
