...
- Effect plugins import `@corro-code/plugin/v2/effect`, not `@corro-code/core`.
- Public domain values use generated `@corro-code/sdk` types.
...
- Define `PluginHost` domain capabilities in `@corro-code/plugin/v2/effect`.
