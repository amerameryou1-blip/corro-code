export const dict: Record<string, string> = {
  ...
  "ui.tool.loadedFile": "{{path}} yuklandi",
  "ui.tool.loadedSkill": "{{name}} ko‘nikmasi yuklandi",
  "ui.tool.shell.writingCommand": "Buyruq yozilmoqda...",
  "ui.tool.agent.delegating": "Agentga topshirilmoqda...",
  "ui.common.moreCount.one": "+yana {{count}} ta",
  "ui.common.moreCount.other": "+yana {{count}} ta",
  "ui.sessionTimeline.notice.model": "Model",
  "ui.sessionTimeline.notice.movedTo": "Ko‘chirildi",
  "ui.sessionTimeline.notice.movedTooltip": "Sessiyaning ish katalogi o‘zgardi",
  "ui.sessionTimeline.notice.failed": "{{actor}} amalga oshmadi",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} bekor qilindi",
