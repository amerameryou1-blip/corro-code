...
1. Kør kommandoen `/connect` i TUI, vælg corro og gå til [corro.ai/auth](https://corrocode.dev/auth).
...
1. Kør kommandoen `/connect` i TUI, vælg `Corro Code Go`, og gå til [corro.ai/auth](https://corrocode.dev/zen).
