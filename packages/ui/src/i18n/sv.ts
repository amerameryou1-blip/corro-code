export const dict: Record<string, string> = {
  ...
  "ui.tool.execute": "Kör",
  "ui.tool.loadedFile": "Läste in {{path}}",
  "ui.tool.loadedSkill": "Läste in färdigheten {{name}}",
  "ui.tool.shell.writingCommand": "Skriver kommando...",
  "ui.tool.agent.delegating": "Delegerar till agent...",
  "ui.common.moreCount.one": "+{{count}} till",
  "ui.common.moreCount.other": "+{{count}} till",
  "ui.sessionTimeline.notice.model": "Modell",
  "ui.sessionTimeline.notice.movedTo": "Flyttad till",
  "ui.sessionTimeline.notice.movedTooltip": "Sessionens arbetskatalog ändrades",
  "ui.sessionTimeline.notice.failed": "{{actor}} misslyckades",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} avbruten",
