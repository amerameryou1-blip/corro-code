...
1. Führen Sie den Befehl `/connect` in TUI aus, wählen Sie Corro Code aus und gehen Sie zu [corro.ai/auth](https://corrocode.dev/auth).
...
1. Führen Sie den Befehl `/connect` in der TUI aus, waehlen Sie `Corro Code Go` und gehen Sie zu [corro.ai/auth](https://corrocode.dev/zen).
