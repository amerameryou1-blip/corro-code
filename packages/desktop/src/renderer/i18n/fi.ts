export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo Corro Coden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "Corro Coden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää Corro Coden uudelleen?",
