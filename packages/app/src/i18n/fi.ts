export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Corro Code tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Corro Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Corro Code.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Corro Code kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Corro Code kohteessa {{distro}}...",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code ei ole asennettu",
  ...
  "toast.update.description": "Corro Code uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "settings.general.row.language.description": "Vaihda Corro Code näyttökieli",
  ...
  "settings.general.row.theme.description": "Mukauta Corro Code teemaa.",
  ...
  "settings.updates.toast.latest.description": "Käytät Corro Code uusinta versiota.",
  ...
  "desktop.recovery.loadFailed": "Corro Code lataaminen epäonnistui",
  ...
  "desktop.wsl.error.installOpencode": "Corro Code asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Corro Code päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
