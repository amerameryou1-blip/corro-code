export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja Corro Code",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać Corro Code",
  "desktop.recovery.terminated": "Okno Corro Code zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "Corro Code nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować Corro Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja Corro Code została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Corro Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Corro Code.",
  ...
  "dialog.server.description": "Przełącz serwer Corro Code, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie Corro Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie Corro Code w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj Corro Code w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj Corro Code w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim Corro Code będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "Corro Code nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz Corro Code.",
  ...
  "help.tabs.introduction": "Corro Code Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja Corro Code ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Corro Code",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: Corro Code nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "Corro Code zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer Corro Code wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Corro Code",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd Corro Code na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy Corro Code ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Corro Code.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Corro Code",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Corro Code.",
