...
Kreiraj `.corro/commands/test.md`:
...
Možete dodati prilagođene komande kroz Corro Code konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom Corro Code [config](/docs/config):
...
- Globalno: `~/.config/corro/commands/`
- Po projektu: `.corro/commands/`
...
Corro Code uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
