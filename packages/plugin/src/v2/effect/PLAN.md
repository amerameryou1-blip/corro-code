...
- Effect plugins import `@corro-ai/plugin/v2/effect`, not `@corro-ai/core`.
- Public domain values use generated `@corro-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@corro-ai/plugin/v2/effect`.
