---
title: Server LSP
description: Corro Code si integra con i tuoi server LSP.
---

Corro Code può integrarsi con server Language Server Protocol (LSP) per usare la diagnostica come feedback per l'agente.

---

## Integrati

Corro Code include diversi server LSP integrati per linguaggi popolari:
...
Quando LSP è abilitato e corro apre un file:
...
Puoi abilitare e personalizzare i server LSP tramite la sezione `lsp` nella configurazione di corro.
