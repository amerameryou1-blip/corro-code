...
Corro Code findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/anomalyco/corro/releases) eller [corrocode.dev/download](https://corrocode.dev/download).
