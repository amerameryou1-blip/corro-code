export const dict = {
  ...
  "ui.tool.loadedFile": "Wczytano plik {{path}}",
  "ui.tool.loadedSkill": "Wczytano umiejętność {{name}}",
  "ui.tool.shell.writingCommand": "Zapisywanie polecenia...",
  "ui.tool.agent.delegating": "Delegowanie do agenta...",
  "ui.common.moreCount.one": "+jeszcze {{count}}",
  "ui.common.moreCount.few": "+jeszcze {{count}}",
  "ui.common.moreCount.many": "+jeszcze {{count}}",
  "ui.common.moreCount.other": "+jeszcze {{count}}",
  "ui.sessionTimeline.notice.model": "Model",
  "ui.sessionTimeline.notice.movedTo": "Przeniesiono do",
  "ui.sessionTimeline.notice.movedTooltip": "Zmieniono katalog roboczy sesji",
  "ui.sessionTimeline.notice.failed": "{{actor}} zakończył się niepowodzeniem",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} został anulowany",
  "ui.sessionTimeline.notice.finished": "{{actor}} zakończył pracę",
  "ui.sessionTimeline.notice.instructionsUpdated": "Zaktualizowano instrukcje",
  "ui.sessionTimeline.notice.restart": "Kontynuowanie po ponownym uruchomieniu",
}
