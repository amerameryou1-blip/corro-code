...
Las habilidades del agente permiten a Corro Code descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
Corro Code busca estas ubicaciones:

- Configuración del proyecto: `.corro/skills/<name>/SKILL.md`
- Configuración global: `~/.config/corro/skills/<name>/SKILL.md`
...
Para las rutas locales del proyecto, Corro Code sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
Carga cualquier `skills/*/SKILL.md` coincidente en `.corro/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/corro/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.corro/skills/git-release/SKILL.md` así:
...
Corro Code enumera las habilidades disponibles en la descripción de la herramienta `skill`.
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `corro.json`:
...
**Para agentes integrados** (en `corro.json`):
