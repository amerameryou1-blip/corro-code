...
Le fichier de configuration a un schéma défini dans [**`corro.ai/config.json`**](https://corrocode.dev/config.json).

La configuration TUI utilise [**`corro.ai/tui.json`**](https://corrocode.dev/tui.json).
