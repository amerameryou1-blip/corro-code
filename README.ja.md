...
# パッケージマネージャー
npm i -g @corro-code@latest        # bun/pnpm/yarn でもOK
...
Corro Code はデスクトップアプリとしても利用できます。[releases page](https://github.com/anomalyco/corro/releases) から直接ダウンロードするか、[corrocode.dev/download](https://corrocode.dev/download) を利用してください。
