...
Konfiguracijski fajl ima šemu koja je definirana u [**`corro.ai/config.json`**](https://corrocode.dev/config.json).

TUI konfiguracija koristi [**`corro.ai/tui.json`**](https://corrocode.dev/tui.json).
