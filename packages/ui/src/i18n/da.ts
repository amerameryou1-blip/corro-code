export const dict = {
  ...
  "ui.tool.loadedFile": "Indlæste {{path}}",
  "ui.tool.loadedSkill": "Indlæste færdigheden {{name}}",
  "ui.tool.shell.writingCommand": "Skriver kommando...",
  "ui.tool.agent.delegating": "Delegerer til agent...",
  "ui.common.moreCount.one": "+{{count}} mere",
  "ui.common.moreCount.other": "+{{count}} mere",
  "ui.sessionTimeline.notice.model": "Model",
  "ui.sessionTimeline.notice.movedTo": "Flyttet til",
  "ui.sessionTimeline.notice.movedTooltip": "Sessionens arbejdsmappe blev ændret",
  "ui.sessionTimeline.notice.failed": "{{actor}} mislykkedes",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} annulleret",
