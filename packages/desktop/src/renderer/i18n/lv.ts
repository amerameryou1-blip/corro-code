export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko Corro Code versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "Corro Code versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
