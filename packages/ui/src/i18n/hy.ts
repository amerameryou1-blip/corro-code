export const dict: Record<string, string> = {
  ...
  "ui.tool.loadedFile": "Բեռնվել է {{path}}",
  "ui.tool.loadedSkill": "Բեռնվել է {{name}} հմտությունը",
  "ui.tool.shell.writingCommand": "Հրամանը գրվում է...",
  "ui.tool.agent.delegating": "Փոխանցվում է գործակալին...",
  "ui.common.moreCount.one": "+ևս {{count}}",
  "ui.common.moreCount.other": "+ևս {{count}}",
  "ui.sessionTimeline.notice.model": "Մոդել",
  "ui.sessionTimeline.notice.movedTo": "Տեղափոխվել է՝",
  "ui.sessionTimeline.notice.movedTooltip": "Նիստի աշխատանքային գրացուցակը փոխվել է",
  "ui.sessionTimeline.notice.failed": "{{actor}}-ը ձախողվեց",
  "ui.sessionTimeline.notice.cancelled": "{{actor}}-ը չեղարկվեց",
