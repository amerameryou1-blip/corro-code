export const dict = {
  ...
  "desktop.updater.none.message": "Már az Corro Code legújabb verzióját használja",
  ...
  "desktop.updater.downloaded.prompt":
    "Az Corro Code {{version}} verziója letöltődött. Szeretné telepíteni és újraindítani az alkalmazást?",
