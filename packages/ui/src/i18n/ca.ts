export const dict: Record<string, string> = {
  ...
  "ui.tool.loadedFile": "S'ha carregat {{path}}",
  "ui.tool.loadedSkill": "S'ha carregat l'habilitat {{name}}",
  "ui.tool.shell.writingCommand": "S'està escrivint l'ordre...",
  "ui.tool.agent.delegating": "S'està delegant l'agent...",
  "ui.common.moreCount.one": "+{{count}} més",
  "ui.common.moreCount.many": "+{{count}} més",
  "ui.common.moreCount.other": "+{{count}} més",
  "ui.sessionTimeline.notice.model": "Model",
  "ui.sessionTimeline.notice.movedTo": "S'ha mogut a",
  "ui.sessionTimeline.notice.movedTooltip": "El directori de treball de la sessió ha canviat",
  "ui.sessionTimeline.notice.failed": "{{actor}} ha fallat",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} s'ha cancel·lat",
  "ui.sessionTimeline.notice.finished": "{{actor}} ha acabat",
  "ui.sessionTimeline.notice.instructionsUpdated": "Instruccions actualitzades",
  "ui.sessionTimeline.notice.restart": "Es continua després de reiniciar",
}
