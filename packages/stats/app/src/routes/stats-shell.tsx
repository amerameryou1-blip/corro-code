    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://corrocode.dev/">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://corrocode.dev/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://corrocode.dev/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@opencode.ai", label: i18n.t("footer.contact") },
    { href: "https://corrocode.dev/discord", label: i18n.t("footer.community") },
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://corrocode.dev" aria-label={i18n.t("footer.homeAria")}>
          <OpenCodeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={opencodeWordmarkDark} alt="Corro Code" />
          <button
