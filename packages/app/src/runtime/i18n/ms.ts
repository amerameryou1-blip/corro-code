export const dict = {
  ...
  "server.row.incompatible":
    "Pelayan ini menjalankan OpenCode {{version}}, yang tidak serasi dengan aplikasi ini. Tingkatkan kepada OpenCode V2 untuk meneruskan.",
  "toast.session.copyID.failed.title": "Gagal menyalin ID sesi",
  "toast.session.copyID.failed.description": "Ralat berlaku semasa menyalin ID sesi",
  "toast.project.copyID.failed.title": "Gagal menyalin ID projek",
  "toast.project.copyID.failed.description": "Ralat berlaku semasa menyalin ID projek",
  "error.page.title.status": "Permintaan pelayan gagal",
  "error.page.description.status": "Pelayan mengembalikan respons HTTP {{status}}.",
  "error.page.action.reload": "Muat semula",
  "session.error.incompatible": "Versi pelayan ini tidak disokong",
  "session.error.incompatible.description":
    "{{server}} menjalankan OpenCode {{version}}, yang tidak serasi dengan aplikasi ini. Tingkatkan pelayan kepada OpenCode V2 untuk meneruskan.",
  "session.background.moveInline": "Tekan {{keybind}} untuk mengalihkan kerja yang sedang berjalan ke latar belakang",
  "session.background.running": "Menjalankan kerja di latar belakang",
  "session.background.runningCount.one": "{{count}} item sedang berjalan di latar belakang",
  "session.background.runningCount.other": "{{count}} item sedang berjalan di latar belakang",
  "settings.general.row.terminalPlacement.title": "Kedudukan terminal",
  "settings.general.row.terminalPlacement.description": "Pilih tempat terminal dibuka dalam sesi",
  "settings.general.row.terminalPlacement.side": "Sisi",
  "settings.general.row.terminalPlacement.bottom": "Bawah",
  "settings.general.row.showProjectIcon.title": "Ikon projek",
  "settings.general.row.showProjectIcon.description": "Tunjukkan ikon projek dalam pengepala sesi",
}
