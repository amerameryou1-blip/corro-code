...
export const dict = {
  ...
  "ui.messagePart.context.match.one": "({{count}} eşleşme)",
  "ui.messagePart.context.match.other": "({{count}} eşleşme)",
  ...
  "ui.tool.loadedFile": "{{path}} yüklendi",
  "ui.tool.loadedSkill": "{{name}} becerisi yüklendi",
  ...
  "ui.common.moreCount.one": "+{{count}} daha",
  "ui.common.moreCount.other": "+{{count}} daha",
  ...
  "ui.sessionTimeline.notice.movedTooltip": "Oturum çalışma dizini değişti",
  "ui.sessionTimeline.notice.failed": "{{actor}} başarısız oldu",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} iptal edildi",
  "ui.sessionTimeline.notice.finished": "{{actor}} tamamlandı",
  "ui.sessionTimeline.notice.instructionsUpdated": "Yönergeler güncellendi",
  "ui.sessionTimeline.notice.restart": "Yeniden başlatmanın ardından devam ediliyor",
