export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} Corro Code a fost descărcată. Vrei să o instalezi și să repornești?",
