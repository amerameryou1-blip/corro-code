...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "Corro Code failed to load",
  "desktop.recovery.terminated": "Corro Code window terminated unexpectedly",
  "desktop.recovery.unresponsive": "Corro Code is not responding",
