...
Ajan becerileri, corro'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
corro su konumlari tarar:

- Proje konfigurasyonu: `.corro/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/corro/skills/<name>/SKILL.md`
...
Proje yerel yollarinda corro, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.corro/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/corro/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.corro/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
corro, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`corro.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`corro.json` icinde):
