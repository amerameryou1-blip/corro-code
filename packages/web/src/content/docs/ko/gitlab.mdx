...
여기서는 OpenCode용 커뮤니티 제작 CI/CD component인 [nagyv/gitlab-corro](https://gitlab.com/nagyv/gitlab-corro)를 사용합니다.
...
- **최소 설정**: CI component가 백그라운드에서 OpenCode를 설정하므로 Corro Code config와 초기 prompt만 만들면 됩니다.
...
댓글에서 `@corro`를 멘션하면 OpenCode가 GitLab CI 파이프라인 안에서 작업을 실행합니다.
