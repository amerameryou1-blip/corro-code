...
# 套件管理員
npm i -g corro-ai@latest        # 也可使用 bun/pnpm/yarn
...
Corro Code 也提供桌面版應用程式。您可以直接從 [發佈頁面 (releases page)](https://github.com/anomalyco/corro/releases) 或 [corro.ai/download](https://corrocode.dev/download) 下載。
