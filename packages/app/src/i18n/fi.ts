export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Corro Coden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Corro Codessa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Corro Codessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Corro Codessa.",
  ...
  "dialog.server.description": "Vaihda Corro Code-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Corro Codea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Corro Codea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Corro Codea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Corro Codea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Corro Code jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Corro Code jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Codea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Corro Code voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Corro Code ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Corro Code uudelleen.",
  ...
  "toast.update.description": "Corro Coden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Corro Code-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Corro Code ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita Corro Code-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Corro Coden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Corro Code näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Corro Code järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Corro Coden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Corro Code käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Corro Coden uusinta versiota.",
  ...
  "desktop.menu.documentation": "Corro Code-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Corro Code-valikko",
  ...
  "desktop.recovery.loadFailed": "Corro Coden lataaminen epäonnistui",
  "desktop.recovery.terminated": "Corro Code-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Corro Code ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Corro Coden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Codea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Corro Coden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Corro Code Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
