...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "Corro Code įkelti nepavyko",
  "Corro Code langas netikėtai užsidarė",
  "Corro Code neatsako",
  ...
  "Corro Code įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "Corro Code neįdiegtas distributyve {{distro}}",
  "Corro Code naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami Corro Code modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje Corro Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius Corro Code.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio Corro Code serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama Corro Code {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas Corro Code {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite Corro Code {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite Corro Code į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad Corro Code galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "Corro Code nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite Corro Code.",
  ...
  "help.tabs.introduction": "Corro Code Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują Corro Code ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą Corro Code komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad Corro Code dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "Corro Code apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "Corro Code darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite Corro Code serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite Corro Code ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip Corro Code atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar Corro Code seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite Corro Code temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas Corro Code",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią Corro Code versiją.",
