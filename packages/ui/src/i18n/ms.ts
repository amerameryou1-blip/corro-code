export const dict: Record<string, string> = {
  ...
  "ui.messagePart.context.match.one": "({{count}} padanan)",
  "ui.messagePart.context.match.other": "({{count}} padanan)",
  ...
  "ui.tool.loadedFile": "Memuatkan {{path}}",
  "ui.tool.loadedSkill": "Memuatkan kemahiran {{name}}",
  "ui.tool.shell.writingCommand": "Menulis arahan...",
  "ui.tool.agent.delegating": "Mewakilkan kepada ejen...",
  "ui.common.moreCount.one": "+{{count}} lagi",
  "ui.common.moreCount.other": "+{{count}} lagi",
  "ui.sessionTimeline.notice.model": "Model",
  "ui.sessionTimeline.notice.movedTo": "Dialihkan ke",
  "ui.sessionTimeline.notice.movedTooltip": "Direktori kerja sesi telah berubah",
  "ui.sessionTimeline.notice.failed": "{{actor}} gagal",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} dibatalkan",
  "ui.sessionTimeline.notice.finished": "{{actor}} selesai",
  "ui.sessionTimeline.notice.instructionsUpdated": "Arahan dikemas kini",
  "ui.sessionTimeline.notice.restart": "Meneruskan selepas dimulakan semula",
}
