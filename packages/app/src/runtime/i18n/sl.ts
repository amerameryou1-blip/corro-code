export const dict = {
  ...
  "command.session.copyID": "Kopiraj ID seje",
  "server.row.incompatible":
    "Ta strežnik uporablja OpenCode {{version}}, ki ni združljiv s to aplikacijo. Za nadaljevanje ga nadgradite na OpenCode V2.",
  "toast.session.copyID.failed.title": "ID-ja seje ni bilo mogoče kopirati",
  "toast.session.copyID.failed.description": "Pri kopiranju ID-ja seje je prišlo do napake",
  "toast.project.copyID.failed.title": "ID-ja projekta ni bilo mogoče kopirati",
  "toast.project.copyID.failed.description": "Pri kopiranju ID-ja projekta je prišlo do napake",
  "error.page.title.status": "Zahteva strežniku ni uspela",
  "error.page.description.status": "Strežnik je vrnil odgovor HTTP {{status}}.",
  "error.page.action.reload": "Znova naloži",
  "session.error.incompatible": "Ta različica strežnika ni podprta",
  "session.error.incompatible.description":
    "{{server}} uporablja OpenCode {{version}}, ki ni združljiv s to aplikacijo. Za nadaljevanje strežnik nadgradite na OpenCode V2.",
  "session.background.moveInline": "Pritisnite {{keybind}}, da premaknete trenutno delo v ozadje",
  "session.background.running": "Delo se izvaja v ozadju",
  "session.background.runningCount.one": "{{count}} element se izvaja v ozadju",
  "session.background.runningCount.two": "{{count}} elementa se izvajata v ozadju",
  "session.background.runningCount.few": "{{count}} elementi se izvajajo v ozadju",
  "session.background.runningCount.other": "{{count}} elementov se izvaja v ozadju",
  "settings.general.row.terminalPlacement.title": "Položaj terminala",
  "settings.general.row.terminalPlacement.description": "Izberite, kje se terminal odpre v sejah",
  "settings.general.row.terminalPlacement.side": "Ob strani",
  "settings.general.row.terminalPlacement.bottom": "Spodaj",
  "settings.general.row.showProjectIcon.title": "Ikona projekta",
  "settings.general.row.showProjectIcon.description": "Prikaži ikono projekta v glavi seje",
}
