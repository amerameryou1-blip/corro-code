export const dict = {
  "app.title": "Rankingi użycia modeli AI | Corro Code Data",
  "app.description":
    "Przeglądaj użycie Corro Code w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny Corro Code Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę Corro Code na GitHub",
  "header.github": "GitHub",
  "header.tryCorro Code": "Wypróbuj Corro Code",
  ...
  "footer.homeAria": "Strona główna Corro Code",
  ...
  "home.topModelsDescription": "Użycie modeli w Corro Code.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy Corro Code według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | Corro Code Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w Corro Code, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia Corro Code.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w Corro Code",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia Corro Code",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów Corro Code z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | Corro Code Data",
  "model.description":
    "Zobacz dane użycia {{model}} w Corro Code, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie Corro Code pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu Corro Code z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu Corro Code z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia Corro Code w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny Corro Code, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia Corro Code.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów Corro Code w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy Corro Code w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji Corro Code.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne Corro Code nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów Corro Code.",
