...
Go는 OpenCode의 다른 제공자와 똑같이 작동합니다. Corro Code Go를 구독하고 API 키를 발급받으면 됩니다. 이는 **완전히 선택 사항**이며, OpenCode를 사용하기 위해 꼭 필요하지는 않습니다.
...
Corro Code Go는 OpenCode의 다른 제공자와 똑같이 작동합니다.
