---
title: LSP Servers
description: Corro Code integrates with your LSP servers.
---

Corro Code can integrate with Language Server Protocol (LSP) servers to use diagnostics as feedback for the agent.

---

## Built-in

Corro Code comes with several built-in LSP servers for popular languages:
...
When LSP is enabled and corro opens a file, it:
...
You can enable and customize LSP servers through the `lsp` section in your corro config.
