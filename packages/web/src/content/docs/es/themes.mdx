...
Con Corro Code puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Corro Code usa nuestro propio tema `corro`.
...
Corro Code viene con varios temas integrados.
...
- Quiere que Corro Code coincida con la apariencia de su terminal
...
Corro Code admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/corro/themes/*.json` o `$XDG_CONFIG_HOME/corro/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.corro/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.corro/themes/*.json`
