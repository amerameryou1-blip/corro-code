export const dict = {
  ...
  "desktop.cli.installed.message":
    "បានដំឡើង CLI ទៅ {{path}}\n\nចាប់ផ្ដើមស្ថានីយរបស់អ្នកឡើងវិញ ដើម្បីប្រើពាក្យបញ្ជា 'opencode2'។",
  "desktop.cli.failed.title": "ការដំឡើងបានបរាជ័យ",
  "desktop.cli.failed.message": "មិនអាចដំឡើង CLI បានទេ៖ {{error}}",
  "command.project.copyID": "ចម្លង ID គម្រោង",
  "command.session.copyID": "ចម្លង ID សម័យ",
  "server.row.incompatible":
    "ម៉ាស៊ីនមេនេះកំពុងដំណើរការ OpenCode {{version}} ដែលមិនត្រូវគ្នាជាមួយកម្មវិធីនេះទេ។ ដំឡើងកំណែទៅ OpenCode V2 ដើម្បីបន្ត។",
  "toast.session.copyID.failed.title": "មិនអាចចម្លង ID សម័យបានទេ",
  "toast.session.copyID.failed.description": "មានកំហុសកើតឡើង ខណៈពេលចម្លង ID សម័យ",
  "toast.project.copyID.failed.title": "មិនអាចចម្លង ID គម្រោងបានទេ",
  "toast.project.copyID.failed.description": "មានកំហុសកើតឡើង ខណៈពេលចម្លង ID គម្រោង",
  "error.page.title.status": "សំណើទៅម៉ាស៊ីនមេបានបរាជ័យ",
  "error.page.description.status": "ម៉ាស៊ីនមេបានឆ្លើយតប HTTP {{status}}។",
  "error.page.action.reload": "ផ្ទុកឡើងវិញ",
  "session.error.incompatible": "កំណែម៉ាស៊ីនមេនេះមិនត្រូវបានគាំទ្រទេ",
  "session.error.incompatible.description":
    "{{server}} កំពុងដំណើរការ OpenCode {{version}} ដែលមិនត្រូវគ្នាជាមួយកម្មវិធីនេះទេ។ ដំឡើងកំណែម៉ាស៊ីនមេទៅ OpenCode V2 ដើម្បីបន្ត។",
  "session.background.moveInline": "ចុច {{keybind}} ដើម្បីផ្លាស់ទីការងារដែលកំពុងដំណើរការទៅផ្ទៃខាងក្រោយ",
  "session.background.running": "កំពុងដំណើរការការងារនៅផ្ទៃខាងក្រោយ",
  "session.background.runningCount.one": "ធាតុ {{count}} កំពុងដំណើរការនៅផ្ទៃខាងក្រោយ",
  "session.background.runningCount.other": "ធាតុ {{count}} កំពុងដំណើរការនៅផ្ទៃខាងក្រោយ",
  "settings.general.row.terminalPlacement.title": "ទីតាំងស្ថានីយ",
  "settings.general.row.terminalPlacement.description": "ជ្រើសរើសទីតាំងដែលស្ថានីយបើកក្នុងសម័យ",
  "settings.general.row.terminalPlacement.side": "ចំហៀង",
  "settings.general.row.terminalPlacement.bottom": "ខាងក្រោម",
  "settings.general.row.showProjectIcon.title": "រូបតំណាងគម្រោង",
  "settings.general.row.showProjectIcon.description": "បង្ហាញរូបតំណាងគម្រោងក្នុងបឋមកថាសម័យ",
}
