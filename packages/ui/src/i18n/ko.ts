export const dict = {
  ...
  "ui.messagePart.context.match.one": "({{count}}개 일치)",
  "ui.messagePart.context.match.other": "({{count}}개 일치)",
  ...
  "ui.tool.loadedFile": "{{path}} 불러옴",
  "ui.tool.loadedSkill": "{{name}} 스킬 불러옴",
  "ui.tool.shell.writingCommand": "명령어 작성 중...",
  "ui.tool.agent.delegating": "에이전트에 위임 중...",
  "ui.common.moreCount.one": "+{{count}}개 더 보기",
  "ui.common.moreCount.other": "+{{count}}개 더 보기",
  "ui.sessionTimeline.notice.model": "모델",
  "ui.sessionTimeline.notice.movedTo": "이동 위치",
  "ui.sessionTimeline.notice.movedTooltip": "세션 작업 디렉터리가 변경됨",
  "ui.sessionTimeline.notice.failed": "{{actor}} 실패",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} 취소됨",
  "ui.sessionTimeline.notice.finished": "{{actor}} 완료",
  "ui.sessionTimeline.notice.instructionsUpdated": "지침 업데이트됨",
  "ui.sessionTimeline.notice.restart": "다시 시작한 후 계속",
}
