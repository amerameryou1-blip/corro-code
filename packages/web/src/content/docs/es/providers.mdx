...
1. Ejecute el comando `/connect` en TUI, seleccione corro y diríjase a [corro.ai/auth](https://corrocode.dev/auth).
...
1. Ejecute el comando `/connect` en TUI, seleccione `Corro Code Go` y diríjase a [corro.ai/auth](https://corrocode.dev/zen).
