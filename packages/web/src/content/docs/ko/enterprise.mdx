...
사용자가 `/share` 기능을 활성화하면, 대화와 관련 데이터가 corrocode.dev의 share 페이지 호스팅 서비스로 전송됩니다.
...
OpenCode는 Bun의 기본 `.npmrc` 지원을 통해 private npm registry를 사용할 수 있습니다. 조직에서 JFrog Artifactory, Nexus 등 private registry를 사용한다면 Corro Code 실행 전에 개발자 인증을 완료하세요.
