...
Il file di configurazione ha uno schema definito in [**`corro.ai/config.json`**](https://corrocode.dev/config.json).

La configurazione TUI usa [**`corro.ai/tui.json`**](https://corrocode.dev/tui.json).
