...
export const dict = {
  ...
  "settings.general.row.showProjectIcon.title": "Projektsymbol",
  "settings.general.row.showProjectIcon.description": "Projektsymbol in der Sitzungsüberschrift anzeigen",
