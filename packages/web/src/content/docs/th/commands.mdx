...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ Corro Code:
...
- ระดับผู้ใช้ (Global): `~/.config/corro/commands/`
- ระดับโปรเจ็กต์: `.corro/commands/`
...
Corro Code มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
