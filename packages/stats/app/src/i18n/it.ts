export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | Corro Code Data",
  "app.description":
    "Esplora l'utilizzo di Corro Code nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo Corro Code Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a Corro Code su GitHub",
  "header.github": "GitHub",
  "header.tryCorro Code": "Prova Corro Code",
  ...
  "footer.homeAria": "Home Corro Code",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in Corro Code.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di Corro Code per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | Corro Code Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in Corro Code, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di Corro Code.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in Corro Code",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di Corro Code",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token Corro Code negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | Corro Code Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in Corro Code, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di Corro Code appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo Corro Code della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo Corro Code della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di Corro Code nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di Corro Code, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di Corro Code.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token Corro Code nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di Corro Code nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione Corro Code.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica Corro Code corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token Corro Code.",
