export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Corro Code",
  ...
  "desktop.menu.ariaLabel": "Corro Code meni",
  ...
  "desktop.recovery.loadFailed": "Corro Code se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Corro Code-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Corro Code ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Corro Code-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Corro Code-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Corro Code-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Corro Code-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Corro Code-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Corro Code server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Corro Code u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Corro Code u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Corro Code u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Corro Code u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Corro Code mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Corro Code nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Corro Code.",
  ...
  "help.tabs.introduction": "Corro Code Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Corro Code-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Corro Code timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Corro Code još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Corro Code server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Corro Code-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Corro Code izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Corro Code prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Corro Code-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Corro Code pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Corro Code-a.",
