export const dict: Record<string, string> = {
  ...
  "ui.tool.loadedFile": "{{path}} yükləndi",
  "ui.tool.loadedSkill": "{{name}} bacarığı yükləndi",
  "ui.tool.shell.writingCommand": "Əmr yazılır...",
  "ui.tool.agent.delegating": "Agentə həvalə edilir...",
  "ui.common.moreCount.one": "+{{count}} əlavə",
  "ui.common.moreCount.other": "+{{count}} əlavə",
  "ui.sessionTimeline.notice.model": "Model",
  "ui.sessionTimeline.notice.movedTo": "Köçürüldü",
  "ui.sessionTimeline.notice.movedTooltip": "Sessiyanın iş qovluğu dəyişdirildi",
  "ui.sessionTimeline.notice.failed": "{{actor}} uğursuz oldu",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} ləğv edildi",
  "ui.sessionTimeline.notice.finished": "{{actor}} tamamlandı",
  "ui.sessionTimeline.notice.instructionsUpdated": "Təlimatlar yeniləndi",
  "ui.sessionTimeline.notice.restart": "Yenidən başladıldıqdan sonra davam edir",
}
