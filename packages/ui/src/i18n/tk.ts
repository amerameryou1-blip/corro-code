export const dict: Record<string, string> = {
  ...
  "ui.tool.loadedFile": "{{path}} ýüklendi",
  "ui.tool.loadedSkill": "{{name}} başarnygy ýüklendi",
  "ui.tool.shell.writingCommand": "Buýruk ýazylýar...",
  "ui.tool.agent.delegating": "Agente tabşyrylýar...",
  "ui.common.moreCount.one": "+ýene {{count}}",
  "ui.common.moreCount.other": "+ýene {{count}}",
  "ui.sessionTimeline.notice.model": "Model",
  "ui.sessionTimeline.notice.movedTo": "Geçirilen ýeri",
  "ui.sessionTimeline.notice.movedTooltip": "Sessiýanyň iş katalogy üýtgedi",
  "ui.sessionTimeline.notice.failed": "{{actor}} başa barmady",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} ýatyryldy",
  "ui.sessionTimeline.notice.finished": "{{actor}} tamamlady",
  "ui.sessionTimeline.notice.instructionsUpdated": "Görkezmeler täzelendi",
  "ui.sessionTimeline.notice.restart": "Täzeden başladylandan soň dowam edýär",
}
