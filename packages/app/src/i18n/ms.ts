export const dict = {
  ...
  "desktop.recovery.loadFailed": "Corro Code gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap Corro Code ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "Corro Code tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan Corro Code gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini Corro Code selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Corro Code.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam Corro Code.",
  ...
  "dialog.server.description": "Tukar pelayan Corro Code yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak Corro Code dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini Corro Code dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini Corro Code dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang Corro Code dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum Corro Code boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "Corro Code tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula Corro Code.",
  ...
  "help.tabs.introduction": "Corro Code Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu Corro Code ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan Corro Code",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, Corro Code belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan Corro Code dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk Corro Code",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa Corro Code pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada Corro Code mengikut sistem, tema cerah, atau gelap",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila Corro Code dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini Corro Code.",
