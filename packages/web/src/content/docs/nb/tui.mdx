---
title: TUI
description: Bruke corro-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Corro Code gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre Corro Code starter TUI for gjeldende katalog.
...
Når du bruker Corro Code TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til Corro Code. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt Corro Code. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `corro.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge Corro Code venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `corro.default`.
