export const dict = {
  ...
  "ui.tool.loadedFile": "Зареден файл {{path}}",
  "ui.tool.loadedSkill": "Заредено умение {{name}}",
  "ui.tool.shell.writingCommand": "Командата се записва...",
  "ui.tool.agent.delegating": "Задачата се възлага на агент...",
  "ui.common.moreCount.one": "+още {{count}}",
  "ui.common.moreCount.other": "+още {{count}}",
  "ui.sessionTimeline.notice.model": "Модел",
  "ui.sessionTimeline.notice.movedTo": "Преместено в",
  "ui.sessionTimeline.notice.movedTooltip": "Работната директория на сесията е променена",
  "ui.sessionTimeline.notice.failed": "{{actor}} завърши неуспешно",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} е отменен",
  "ui.sessionTimeline.notice.finished": "{{actor}} завърши",
  "ui.sessionTimeline.notice.instructionsUpdated": "Инструкциите са актуализирани",
  "ui.sessionTimeline.notice.restart": "Продължаване след рестартиране",
}
