...
1. Запустите команду `/connect` в TUI, выберите `Corro Code Zen` и перейдите по адресу [corro.ai/auth](https://corrocode.dev/zen).
...
1. Запустите команду `/connect` в TUI, выберите `Corro Code Go` и перейдите по адресу [corro.ai/auth](https://corrocode.dev/zen).
