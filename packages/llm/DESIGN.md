...
> current private `@corro-code/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@corro-code/ai`
...
- Secondary audience: Corro Code and other durable agent runtimes
...
import { LLM } from "@corro-code/ai"
import { OpenAI } from "@corro-code/ai/providers/openai"
...
```ts
import { Message } from "@corro-code/ai"
...
import { LLM, Tool } from "@corro-code/ai"
...
Corro Code and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@corro-code/ai/promise"
import { OpenAI } from "@corro-code/ai/providers/openai"
...
```ts
import { LLMSchema } from "@corro-code/ai/schema"
...
```ts
import { Provider, Protocol } from "@corro-code/ai/provider"
...
@corro-code/ai/promise
  Promise/AsyncIterable LLM facade

@corro-code/ai/schema
  serializable domain schemas

@corro-code/ai/provider
  experimental Provider and Protocol authoring APIs

@corro-code/ai/providers/openai
@corro-code/ai/providers/anthropic
@corro-code/ai/providers/google
...
```
...
Corro Code should migrate to `generateTurn` / `streamTurn`, preserving its durable
