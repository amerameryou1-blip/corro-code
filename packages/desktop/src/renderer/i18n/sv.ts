export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av Corro Code har laddats ned. Vill du installera den och starta om programmet?",
