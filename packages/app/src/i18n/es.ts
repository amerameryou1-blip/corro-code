export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de Corro Code",
  ...
  "desktop.menu.ariaLabel": "Menú de Corro Code",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar Corro Code",
  "desktop.recovery.terminated": "La ventana de Corro Code se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "Corro Code no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar Corro Code",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "Corro Code no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de Corro Code finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Corro Code",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Corro Code.",
  ...
  "provider.connect.opencodeZen.line1":
    "Corro Code Trial te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Corro Code.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Corro Code.",
  ...
  "dialog.server.description": "Cambiar el servidor de Corro Code al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando Corro Code...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando Corro Code en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando Corro Code...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando Corro Code en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza Corro Code en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar Corro Code",
  "wsl.onboarding.opencodeReadyIn": "Corro Code está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "Corro Code está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala Corro Code en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar Corro Code",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Corro Code no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que Corro Code pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "Corro Code no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir Corro Code.",
  ...
  "help.tabs.introduction": "Corro Code Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de Corro Code ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de Corro Code",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: Corro Code aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "Corro Code incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Corro Code dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Corro Code",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve Corro Code en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si Corro Code sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Corro Code.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Corro Code",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Corro Code.",
