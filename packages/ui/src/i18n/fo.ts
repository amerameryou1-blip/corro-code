export const dict: Record<string, string> = {
  ...
  "ui.tool.loadedFile": "{{path}} varð lisið inn",
  "ui.tool.loadedSkill": "Førleikin {{name}} varð lisin inn",
  "ui.tool.shell.writingCommand": "Skrivar stýriboð...",
  "ui.tool.agent.delegating": "Letur agenti arbeiðið...",
  "ui.common.moreCount.one": "+{{count}} afturat",
  "ui.common.moreCount.other": "+{{count}} afturat",
  "ui.sessionTimeline.notice.model": "Modell",
  "ui.sessionTimeline.notice.movedTo": "Flutt til",
  "ui.sessionTimeline.notice.movedTooltip": "Arbeiðsmappan hjá setuni broyttist",
  "ui.sessionTimeline.notice.failed": "{{actor}} miseydnaðist",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} varð avlýstur",
  "ui.sessionTimeline.notice.finished": "{{actor}} varð liðugur",
  "ui.sessionTimeline.notice.instructionsUpdated": "Vegleiðingar dagførdar",
  "ui.sessionTimeline.notice.restart": "Heldur fram eftir endurbyrjan",
}
