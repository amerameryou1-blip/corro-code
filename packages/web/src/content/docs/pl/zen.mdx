---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Corro Code.
---
...
Corro Code Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Corro Code.

Zen działa jak każdy inny dostawca w Corro Code. Logujesz się do Corro Code Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Corro Code.
:::
...
Corro Code Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Corro Code Zen działa jak każdy inny dostawca w Corro Code.

1. Logujesz się do **<a href={console}>Corro Code Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Corro Code Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Corro Code używa formatu
`corro/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`corro/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. Corro Code używa tych modeli do generowania tytułów sesji.
...
- MiMo-V2.5 Free jest dostępny w Corro Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 3.0 Flash Fin Free jest dostępny w Corro Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w Corro Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3.5 Lightning Free jest dostępny w Corro Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Corro Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Muse Spark 1.2 Contributor Free jest dostępny w Corro Code przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy Corro Code Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Corro Code także dowolnego innego dostawcy.
