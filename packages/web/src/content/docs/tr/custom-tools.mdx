---
title: Özel Araçlar
description: LLM'un corro'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. corro'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.corro/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/corro/tools/` içine yerleştirerek.
