...
Puoi aggiungere comandi personalizzati tramite la config di Corro Code o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di Corro Code:
...
- Globale: `~/.config/corro/commands/`
- Per progetto: `.corro/commands/`
...
corro include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
