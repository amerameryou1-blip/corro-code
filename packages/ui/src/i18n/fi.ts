export const dict: Record<string, string> = {
  ...
  "ui.tool.loadedFile": "Ladattiin {{path}}",
  "ui.tool.loadedSkill": "Ladattiin taito {{name}}",
  "ui.tool.shell.writingCommand": "Kirjoitetaan komentoa...",
  "ui.tool.agent.delegating": "Delegoidaan agentille...",
  "ui.common.moreCount.one": "+{{count}} muu",
  "ui.common.moreCount.other": "+{{count}} muuta",
  "ui.sessionTimeline.notice.model": "Malli",
  "ui.sessionTimeline.notice.movedTo": "Siirretty kohteeseen",
  "ui.sessionTimeline.notice.movedTooltip": "Istunnon työhakemisto vaihtui",
  "ui.sessionTimeline.notice.failed": "{{actor}} epäonnistui",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} peruutettu",
  "ui.sessionTimeline.notice.finished": "{{actor}} valmis",
  "ui.sessionTimeline.notice.instructionsUpdated": "Ohjeet päivitetty",
  "ui.sessionTimeline.notice.restart": "Jatketaan uudelleenkäynnistyksen jälkeen",
}
