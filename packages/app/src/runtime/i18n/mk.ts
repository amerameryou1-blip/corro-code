export const dict = {
  ...
  "desktop.cli.installed.message":
    "CLI е инсталиран во {{path}}\n\nРестартирајте го терминалот за да ја користите наредбата 'opencode2'.",
  "desktop.cli.failed.title": "Инсталацијата не успеа",
  "desktop.cli.failed.message": "CLI не може да се инсталира: {{error}}",
  "command.project.copyID": "Копирај ID на проектот",
  "command.session.copyID": "Копирај ID на сесијата",
  "server.row.incompatible":
    "Овој сервер користи OpenCode {{version}}, кој не е компатибилен со апликацијава. Надградете го на OpenCode V2 за да продолжите.",
  "toast.session.copyID.failed.title": "Копирањето на ID на сесијата не успеа",
  "toast.session.copyID.failed.description": "Настана грешка при копирањето на ID на сесијата",
  "toast.project.copyID.failed.title": "Копирањето на ID на проектот не успеа",
  "toast.project.copyID.failed.description": "Настана грешка при копирањето на ID на проектот",
  "error.page.title.status": "Барањето до серверот не успеа",
  "error.page.description.status": "Серверот врати HTTP одговор {{status}}.",
  "error.page.action.reload": "Превчитај",
  "session.error.incompatible": "Оваа верзија на серверот не е поддржана",
  "session.error.incompatible.description":
    "{{server}} користи OpenCode {{version}}, кој не е компатибилен со апликацијава. Надградете го серверот на OpenCode V2 за да продолжите.",
  "session.background.moveInline": "Притиснете {{keybind}} за да ја преместите тековната работа во заднина",
  "session.background.running": "Работата се извршува во заднина",
  "session.background.runningCount.one": "{{count}} ставка се извршува во заднина",
  "session.background.runningCount.other": "{{count}} ставки се извршуваат во заднина",
  "settings.general.row.terminalPlacement.title": "Положба на терминалот",
  "settings.general.row.terminalPlacement.description": "Изберете каде да се отвора терминалот во сесиите",
  "settings.general.row.terminalPlacement.side": "Отстрана",
  "settings.general.row.terminalPlacement.bottom": "Долу",
  "settings.general.row.showProjectIcon.title": "Икона на проектот",
  "settings.general.row.showProjectIcon.description": "Прикажи ја иконата на проектот во заглавието на сесијата",
}
