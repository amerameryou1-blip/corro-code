---
title: LSP-servere
description: Corro Code integreres med dine LSP-servere.
---

Corro Code kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

Corro Code leveres med flere indbyggede LSP-servere til populære sprog:
...
Når LSP er aktiveret, og corro åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din corro-konfiguration.
