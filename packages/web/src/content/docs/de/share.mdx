---
title: Teilen
description: Teile Corro Code-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu Corro Code-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht Corro Code Folgendes:
...
Corro Code hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Corro Code den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`corro.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du corro in deiner Organisation einsetzt.
