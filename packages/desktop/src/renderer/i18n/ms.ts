export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} Corro Code telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
