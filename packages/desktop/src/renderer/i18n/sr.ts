export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од Corro Code је преузета, да ли желите да је инсталирате и поново покренете?",
