...
The server/runtime config schema is defined in [**`corro.ai/config.json`**](https://corrocode.dev/config.json).

TUI config uses [**`corro.ai/tui.json`**](https://corrocode.dev/tui.json).
