export const dict = {
  "app.title": "Ranking de uso de modelos de IA | Corro Code Data",
  "app.description":
    "Explore o uso do Corro Code em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do Corro Code Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao Corro Code no GitHub",
  "header.github": "GitHub",
  "header.tryCorro Code": "Experimente o Corro Code",
  ...
  "footer.homeAria": "Início do Corro Code",
  ...
  "modal.title": "Newsletter do Corro Code",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no Corro Code.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do Corro Code por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | Corro Code Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no Corro Code, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do Corro Code.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no Corro Code",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do Corro Code",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do Corro Code nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | Corro Code Data",
  "model.description":
    "Veja dados de uso de {{model}} no Corro Code, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no Corro Code aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do Corro Code da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do Corro Code da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do Corro Code na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do Corro Code, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do Corro Code.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do Corro Code na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do Corro Code na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do Corro Code.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do Corro Code correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do Corro Code.",
