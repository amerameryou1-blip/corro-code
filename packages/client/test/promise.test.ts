...
import { isSessionNotFoundError, isUnauthorizedError, Corro Code } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = Corro Code.make({ baseUrl: "http://localhost:3000" })
