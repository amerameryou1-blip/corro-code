...
Corro Code Go is a low cost **$10/month subscription** that gives you reliable access to popular open coding models.

Go works like any other provider in Corro Code. You subscribe to Corro Code Go and
...
Corro Code Go gives you access to these models for **$10/month**.

---

## How it works

Corro Code Go works like any other provider in Corro Code.

1. You sign in to **<a href={console}>Corro Code Zen</a>**, subscribe to Go, and
   copy your API key.
2. You run the `/connect` command in the TUI, select `Corro Code Go`, and paste
   your API key.
3. Run `/models` in the TUI to see the list of models available through Go.

:::note
Only one member per workspace can subscribe to Corro Code Go.
:::
...
Corro Code Go is designed to be used with [Corro Code](https://corrocode.dev) and other
...
Corro Code Go includes the following limits:
...
uses the format `corro-go/<model-id>`. For example, for Kimi K3, you would
use `corro-go/kimi-k3` in your config.
...
4. Have **no lock-in** by allowing you to use any other provider with Corro Code as well.
