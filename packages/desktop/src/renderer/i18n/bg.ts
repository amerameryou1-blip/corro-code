export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на Corro Code",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от Corro Code е изтеглена. Искате ли да я инсталирате и рестартирате?",
