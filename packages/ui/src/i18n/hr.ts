export const dict: Record<string, string> = {
  ...
  "ui.tool.loadedFile": "Učitana datoteka {{path}}",
  "ui.tool.loadedSkill": "Učitana vještina {{name}}",
  "ui.tool.shell.writingCommand": "Pisanje naredbe...",
  "ui.tool.agent.delegating": "Delegiranje agentu...",
  "ui.common.moreCount.one": "+još {{count}}",
  "ui.common.moreCount.few": "+još {{count}}",
  "ui.common.moreCount.other": "+još {{count}}",
  "ui.sessionTimeline.notice.model": "Model",
  "ui.sessionTimeline.notice.movedTo": "Premješteno u",
  "ui.sessionTimeline.notice.movedTooltip": "Radni direktorij sesije je promijenjen",
  "ui.sessionTimeline.notice.failed": "{{actor}} nije uspio",
  "ui.sessionTimeline.notice.cancelled": "{{actor}} je otkazan",
  "ui.sessionTimeline.notice.finished": "{{actor}} je završio",
  "ui.sessionTimeline.notice.instructionsUpdated": "Upute su ažurirane",
  "ui.sessionTimeline.notice.restart": "Nastavak nakon ponovnog pokretanja",
}
