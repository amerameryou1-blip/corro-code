---
title: LSP-servere
description: corro integreres med LSP-serverne dine.
---

Corro Code kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

Corro Code kommer med flere innebygde LSP-servere for populære språk:
...
Når LSP er aktivert og corro åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i Corro Code-konfigurasjonen.
