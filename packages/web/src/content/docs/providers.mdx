...
1. Run the `/connect` command in the TUI, select `Corro Code Zen`, and head to [corro.ai/auth](https://corrocode.dev/zen).
...
1. Run the `/connect` command in the TUI, select `Corro Code Go`, and head to [corro.ai/auth](https://corrocode.dev/zen).
