...
# Paketmanager
npm i -g @corro-code@latest        # oder bun/pnpm/yarn
scoop install corro             # Windows
choco install corro             # Windows
brew install anomalyco/tap/corro # macOS und Linux (empfohlen, immer aktuell)
brew install corro              # macOS und Linux (offizielle Brew-Formula, seltener aktualisiert)
sudo pacman -S corro            # Arch Linux (Stable)
paru -S corro-bin               # Arch Linux (Latest from AUR)
mise use -g corro               # jedes Betriebssystem
nix run nixpkgs#corro           # oder github:anomalyco/corro für den neuesten dev-Branch
```
...
Corro Code ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/anomalyco/corro/releases) oder [corrocode.dev/download](https://corrocode.dev/download) herunter.
...
Corro Code enthält zwei eingebaute Agents, zwischen denen du mit der `Tab`-Taste wechseln kannst.
...
Mehr dazu unter [Agents](https://corrocode.dev/docs/agents).

### Dokumentation

Mehr Infos zur Konfiguration von Corro Code findest du in unseren [**Docs**](https://corrocode.dev/docs).

### Beitragen

Wenn du zu Corro Code beitragen möchtest, lies bitte unsere [Contributing Docs](./CONTRIBUTING.md), bevor du einen Pull Request einreichst.

### Auf Corro Code aufbauen

Wenn du an einem Projekt arbeitest, das mit Corro Code zusammenhängt und "corro" als Teil seines Namens verwendet (z.B. "corro-dashboard" oder "corro-mobile"), füge bitte einen Hinweis in deine README ein, dass es nicht vom Corro Code-Team gebaut wird und nicht in irgendeiner Weise mit uns verbunden ist.

---

**Tritt unserer Community bei** [Discord](https://discord.gg/corro) | [X.com](https://x.com/corro)
